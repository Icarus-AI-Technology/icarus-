    ...
    },
    {
      ...
      campos: (
        <div className={FORM_GRID}>
          <FormField
            id="valor_produtos"
            label="Valor dos Produtos (R$)"
            required
            error={errors.valor_produtos?.message}
          >
            <NeuInput
              id="valor_produtos"
              type="number"
              step="0.01"
              placeholder="0.00"
              error={!!errors.valor_produtos}
              {...register('valor_produtos', { valueAsNumber: true })}
            />
          </FormField>
          ...
          <FormField id="valor_seguro" label="Seguro (R$)">
            <NeuInput
              ...
              step="0.01"
              placeholder="0.00"
              {...register('valor_seguro', { valueAsNumber: true })}
            />
          </FormField>
          ...
          <FormField id="valor_ipi" label="IPI (R$)">
            <NeuInput
              ...
              step="0.01"
              placeholder="0.00"
              {...register('valor_ipi', { valueAsNumber: true })}
            />
          </FormField>
          ...
          <FormField id="valor_pis" label="PIS (R$)">
            <NeuInput
              ...
              step="0.01"
              placeholder="0.00"
              {...register('valor_pis', { valueAsNumber: true })}
            />
          </FormField>
          ...
          <FormField id="valor_cofins" label="COFINS (R$)">
            <NeuInput
              ...
              step="0.01"
              placeholder="0.00"
              {...register('valor_cofins', { valueAsNumber: true })}
            />
          </FormField>
