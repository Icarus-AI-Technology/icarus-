                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {contrato.renovacao_automatica && (
                      <span className="px-3 py-1 bg-orx-info/10 text-orx-info orx-text-xs orx-font-medium rounded-lg flex items-center gap-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                      ...
                      <p className="orx-text-sm orx-font-medium text-orx-text-primary capitalize">
