...
export const NotasCompraReformatted: React.FC = () => {
  ...
  const { notaFiscal, loading: sefazLoading, error: sefazError, consultarNota, limpar } = useSEFAZ();
  ...
  const [notas, setNotas] = useState<NotaFiscalCompra[]>([
    {
      id: '1',
    ...
    if (monitoramentoAtivo && cnpjCliente) {
      const interval = setInterval(async () => {
        try {
          ...
          console.error('Erro ao verificar novas notas:', error);
        }
