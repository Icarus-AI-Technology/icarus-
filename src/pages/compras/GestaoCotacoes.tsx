...
import type { Cotacao, FornecedorCotacao, ItemCotacao } from '../../types/compras';
...
export const GestaoCotacoes: React.FC = () => {
  ...
  const handleEnviarCotacao = (id: string) => {
    // Implementar envio para fornecedores
    console.log('Enviar cotação:', id);
  };

  const handleAprovarCotacao = (id: string) => {
    // Implementar aprovação
    console.log('Aprovar cotação:', id);
  };
