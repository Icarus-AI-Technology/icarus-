...
import type { NotaFiscalCompra, ItemNotaFiscal } from '../../types/compras';
...
export const NotasCompra: React.FC = () => {
  ...
  const parseXMLNFe = async (file: File) => {
    // Simular parse de XML
  ...
  const parseDANFEWithOCR = async (file: File) => {
    // Simular OCR
  ...
  return (
    ...
    >
      ...
      {processing && (
        ...
        >
          <Loader2 size={48} style={{ color: 'var(--orx-primary)', animation: 'spin 1s linear infinite' }} />
          <p style={{ fontSize: '0.813rem', color: 'var(--orx-text-primary)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div
            style={{
              ...
              border: `1px solid ${validacaoStatus.sefaz ? 'var(--orx-success-dark)' : 'var(--orx-error-dark)'}`,
            }}
          >
          ...
          >
            ...
            >
              <div>
                <p style={{ fontSize: '0.813rem', color: 'var(--orx-text-secondary)' }}>Número</p>
                <p style={{ fontSize: '0.813rem', fontWeight: 600, color: 'var(--orx-text-primary)' }}>
                  {nfe.numero_nfe}
                </p>
              </div>
              <div>
                <p style={{ fontSize: '0.813rem', color: 'var(--orx-text-secondary)' }}>Série</p>
                <p style={{ fontSize: '0.813rem', fontWeight: 600, color: 'var(--orx-text-primary)' }}>
                  {nfe.serie}
                </p>
              </div>
              <div>
                <p style={{ fontSize: '0.813rem', color: 'var(--orx-text-secondary)' }}>Data Emissão</p>
                <p style={{ fontSize: '0.813rem', fontWeight: 600, color: 'var(--orx-text-primary)' }}>
                  {new Date(nfe.data_emissao).toLocaleDateString('pt-BR')}
                </p>
              </div>
              <div>
                <p style={{ fontSize: '0.813rem', color: 'var(--orx-text-secondary)' }}>Valor Total</p>
                <p
                  style={{
                    fontSize: '0.813rem',
                    fontWeight: 'var(--orx-font-bold)',
              ...
              <div style={{ gridColumn: 'span 2' }}>
                <p style={{ fontSize: '0.813rem', color: 'var(--orx-text-secondary)' }}>Fornecedor</p>
                <p style={{ fontSize: '0.813rem', fontWeight: 600, color: 'var(--orx-text-primary)' }}>
                  {nfe.fornecedor_nome}
                </p>
