...
import { Search, Package, TrendingDown, TrendingUp, DollarSign, Calendar, Building2, CheckCircle2, AlertCircle } from 'lucide-react';
import { cn } from '@/lib/utils';

export const PesquisaPrecos = () => {
  ...
  const handleBuscarANVISA = async () => {
    try {
      ...
      console.error('Erro ao buscar produto ANVISA:', error);
    }
  };
    ...
    <div className="min-h-screen p-6 bg-[var(--background)]">
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          {produtoANVISA && (
            <div className="mt-4 p-4 rounded-lg bg-[var(--orx-success)]/10 border border-[var(--orx-success)]">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[var(--orx-success)] mb-2" style={{ fontSize: '0.813rem', fontWeight: 600 }}>
                    Produto validado na ANVISA ✓
                  </p>
                  <div className="grid grid-cols-2 gap-3 text-[var(--text-primary)]" style={{ fontSize: '0.813rem' }}>
                    <div>
        ...
        <Card className="p-6">
          ...
          <div className="mb-6">
            <label className="block text-[var(--text-primary)] mb-3" style={{ fontSize: '0.813rem', fontWeight: 500 }}>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <Card className="p-4 bg-[var(--orx-success)]/10 border border-[var(--orx-success)]">
                ...
                <p className="text-[var(--orx-success)]" style={{ fontSize: '0.813rem', fontWeight: 700 }}>
              ...
              <Card className="p-4 bg-[var(--primary)]/10 border border-[var(--primary)]">
                ...
                <p className="text-[var(--primary)]" style={{ fontSize: '0.813rem', fontWeight: 700 }}>
              ...
              <Card className="p-4 bg-[var(--orx-error)]/10 border border-[var(--orx-error)]">
                ...
                <p className="text-[var(--orx-error)]" style={{ fontSize: '0.813rem', fontWeight: 700 }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 rounded-lg bg-[var(--surface)]">
              <div>
                ...
                <p className="text-[var(--text-primary)] font-mono" style={{ fontSize: '0.813rem', fontWeight: 600 }}>
                  {precosSEFAZ.ncm}
                </p>
              </div>
              <div>
                ...
                <p className="text-[var(--text-primary)]" style={{ fontSize: '0.813rem', fontWeight: 600 }}>
              ...
              <div>
                ...
                <p className="text-[var(--orx-warning)]" style={{ fontSize: '0.813rem', fontWeight: 600 }}>
            ...
            {/* Estados */}
            <div className="mt-4">
              <p className="text-[var(--text-secondary)] mb-2" style={{ fontSize: '0.813rem' }}>
