        ...
        >
          ...
          <div className="mb-8">
            <div className="inline-flex items-center justify-center w-32 h-32 rounded-full neumorphic-card">
              <span className="text-[var(--primary)]" style={{  fontWeight: 700 , fontSize: '0.813rem' }}>404</span>
            </div>
          </div>
          ...
          <div className="mb-8 p-4 bg-[var(--muted)] dark:bg-card rounded-lg">
            <p className="text-text-secondary-light dark:text-text-secondary-dark mb-2" style={{ fontSize: '0.813rem' }}>
              Possíveis motivos:
            </p>
            <ul className="text-text-secondary-light dark:text-text-secondary-dark text-left list-disc list-inside space-y-1" style={{ fontSize: '0.813rem' }}>
