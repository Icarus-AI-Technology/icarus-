        ...
        <div className="neumorphic-card p-6 rounded-2xl bg-[var(--orx-bg-light)] shadow-orx-soft">
          <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <Package size={24} color="var(--orx-text-white)" />
              </div>
        ...
        <div className="neumorphic-card p-6 rounded-2xl bg-[var(--orx-bg-light)] shadow-orx-soft">
          <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <Users size={24} color="var(--orx-text-white)" />
              </div>
              ...
              <tbody>
                {topHospitais.map((hospital, index) => (
                  <tr key={index} className="border-b border-[rgba(99,102,241,0.05)]">
                    ...
                    <td className="p-4 text-center">
                      <span
                        className={`inline-flex items-center gap-1 text-[0.813rem] orx-orx-font-semibold ${hospital.crescimentoUp ? 'text-[var(--orx-success)]' : 'text-[var(--orx-error)]'}`}
                      >
