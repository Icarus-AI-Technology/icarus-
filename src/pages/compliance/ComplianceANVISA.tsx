      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="orx-text-3xl orx-font-bold text-orx-text-primary">Compliance ANVISA</h1>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="orx-text-lg orx-font-semibold text-orx-text-primary">{prod.nome}</h3>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                    <div>
                      ...
                      <p className="orx-text-sm orx-font-medium text-orx-text-primary">{prod.lote}</p>
                    </div>
                    <div>
                      <p className="orx-text-xs text-orx-text-muted mb-1">Registro ANVISA</p>
                      <p className="orx-text-sm orx-font-medium text-orx-text-primary">{prod.registro_anvisa}</p>
                    </div>
                    <div>
                      <p className="orx-text-xs text-orx-text-muted mb-1">Fabricante</p>
                      <p className="orx-text-sm orx-font-medium text-orx-text-primary">{prod.fabricante}</p>
                    </div>
                    <div>
