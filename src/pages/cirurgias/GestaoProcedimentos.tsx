      ...
      <div className="max-w-7xl mx-auto">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                    ...
                    <div>
                      ...
                      <p className="orx-text-sm orx-font-medium text-orx-success">
                        {proc.valor_tabela 
                    ...
                    <div>
                      ...
                      <span className={`
                        px-2 py-1 rounded orx-text-xs orx-font-medium
        ...
        {filteredProcedimentos.length === 0 && (
          <div className="bg-orx-bg-surface rounded-xl p-12 shadow-neumo text-center">
            ...
            <h3 className="orx-text-xl orx-font-semibold text-orx-text-primary mb-2">
