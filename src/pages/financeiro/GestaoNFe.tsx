        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="orx-text-3xl orx-font-bold text-orx-text-primary">Gestão de NF-e</h1>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="orx-text-lg orx-font-semibold text-orx-text-primary">NF-e: {nfe.numero}</h3>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="orx-text-sm orx-font-medium text-orx-text-primary">{nfe.cliente}</p>
                    </div>
                    <div>
                      <p className="orx-text-xs text-orx-text-muted mb-1">Valor Total</p>
                      <p className="orx-text-sm orx-font-semibold text-orx-success">R$ {nfe.valor_total.toLocaleString('pt-BR')}</p>
                    </div>
                    <div>
