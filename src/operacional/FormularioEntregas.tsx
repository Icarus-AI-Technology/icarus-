      ...
      campos: (
        <div className={FORM_GRID}>
          <FormField
            ...
            required
            error={errors.destinatario_nome?.message}
            className={FORM_COL.twoThirds}
          >
            <NeuInput
              id="destinatario_nome"
              placeholder="Nome completo ou razão social"
              error={!!errors.destinatario_nome}
          ...
          <FormField
            ...
            required
            error={errors.destinatario_endereco?.message}
            className={FORM_COL.full}
          >
            <NeuInput
              id="destinatario_endereco"
              placeholder="Rua, número, complemento..."
              error={!!errors.destinatario_endereco}
              {...register('destinatario_endereco')}
            />
          </FormField>
          ...
          <FormField
            ...
            label="Cidade"
            required
            error={errors.destinatario_cidade?.message}
          >
            <NeuInput
              id="destinatario_cidade"
              placeholder="São Paulo"
              error={!!errors.destinatario_cidade}
          ...
          <FormField
            ...
            label="Estado"
            required
            error={errors.destinatario_estado?.message}
          >
            <NeuInput
              id="destinatario_estado"
              placeholder="SP"
              maxLength={2}
              error={!!errors.destinatario_estado}
              {...register('destinatario_estado')}
            />
          </FormField>
      ...
      campos: (
        <div className={FORM_GRID}>
          <FormField
            ...
            required
            error={errors.data_programada?.message}
          >
            <NeuInput
              id="data_programada"
              type="date"
              error={!!errors.data_programada}
              {...register('data_programada')}
            />
          </FormField>
        ...
        <div className={FORM_GRID}>
          ...
          <FormField id="quantidade_volumes" label="Quantidade de Volumes">
            <NeuInput
              ...
              type="number"
              placeholder="1"
              {...register('quantidade_volumes', { valueAsNumber: true })}
            />
          </FormField>
          ...
          <FormField id="peso_total" label="Peso Total (kg)">
            <NeuInput
              ...
              step="0.01"
              placeholder="0.00"
              {...register('peso_total', { valueAsNumber: true })}
            />
          </FormField>
          ...
          <div className="lg:col-span-12 flex flex-wrap gap-4">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="orx-text-sm text-[hsl(var(--text-secondary))]">
