        ...
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center gap-2">
            <Calendar
              size={20}
              strokeWidth={1.5}
              className="flex-shrink-0 text-[var(--orx-text-secondary)]"
            />
            <select
                  ...
                  return (
                    <tr
                      ...
                      style={{
                        ...
                        backgroundColor: isResultado ? 'rgba(99, 102, 241, 0.05)' : 'transparent',
                      }}
                    >
                      <td
                        style={{
                      ...
                      <td
                        style={{
                          ...
                          fontFamily: 'var(--orx-font-family)',
                          color:
                            item.percentual < 0 ? 'var(--orx-error)' : 'var(--orx-text-secondary)',
                          fontWeight: isTotal ? 700 : 400,
                        }}
                      >
