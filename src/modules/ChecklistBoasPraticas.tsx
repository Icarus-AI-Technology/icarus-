...
import {
  RelatorioTecnovigilanciaANVISA,
  RelatorioRastreabilidadeXML,
} from '@/services/quality/AutomatedReportsService';
...
export default function ChecklistBoasPraticas() {
  ...
  const exportarRelatorioXML = async () => {
    ...
    try {
      ...
      RelatorioTecnovigilanciaANVISA.downloadXML(
        xml,
        `rastreabilidade-${format(new Date(), 'yyyyMMdd')}.xml`
      );
    } catch (error) {
    ...
    <div style={{ padding: '2rem' }}>
      ...
      >
        ...
        <div className="neumorphic-card" style={{ padding: '1rem', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '0.75rem', color: 'var(--orx-text-secondary)' }}>✅ Conforme</div>
        </div>
        ...
        <div className="neumorphic-card" style={{ padding: '1rem', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '0.75rem', color: 'var(--orx-text-secondary)' }}>🟡 Parcial</div>
        </div>
        ...
        <div className="neumorphic-card" style={{ padding: '1rem', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '0.75rem', color: 'var(--orx-text-secondary)' }}>⏳ Pendente</div>
        </div>
      </div>
        ...
        {categorias.map((cat) => (
          <button
            ...
            style={{
              ...
              border:
                filtroCategoria === cat
                  ? '2px solid var(--orx-primary)'
                  : '1px solid var(--orx-border)',
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {(item.responsavel || item.prazo) && (
                    ...
                    >
                      ...
                      {item.prazo && (
                        <span>
                          <strong>Prazo:</strong> {format(item.prazo, 'dd/MM/yyyy')}
                        </span>
                      )}
                    </div>
                  )}
