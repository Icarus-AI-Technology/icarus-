...
export interface NaoConformidade {
  ...
  origem: 'auditoria_interna' | 'auditoria_externa' | 'cliente' | 'fornecedor' | 'autoinspecao';
...
export interface TreinamentoCertificacao {
  ...
  fabricante?: 'abbott' | 'medtronic' | 'jnj' | 'stryker' | 'boston_scientific' | 'geral' | null;
  categoria: 'opme' | 'qualidade' | 'regulatorio' | 'etica' | 'seguranca' | 'operacional';
