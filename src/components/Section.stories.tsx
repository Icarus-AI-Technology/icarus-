...
export const Default: Story = {
  args: {
    children: (
      <Card className="p-6">
        <h2 className="orx-text-xl orx-font-bold mb-2">Seção Padrão</h2>
...
export const SmallPadding: Story = {
  args: {
    children: (
      <Card className="p-6">
        <h2 className="orx-text-xl orx-font-bold mb-2">Seção com Padding Pequeno</h2>
        <p className="text-[var(--orx-text-secondary)]">
...
export const LargePadding: Story = {
  args: {
    children: (
      <Card className="p-6">
        <h2 className="orx-text-xl orx-font-bold mb-2">Seção com Padding Grande</h2>
        <p className="text-[var(--orx-text-secondary)]">
...
export const NoPadding: Story = {
  args: {
    children: (
      <Card className="p-6">
        <h2 className="orx-text-xl orx-font-bold mb-2">Seção Sem Padding</h2>
        <p className="text-[var(--orx-text-secondary)]">
...
export const MultipleSections: Story = {
  render: () => (
    <div>
      <Section padding="md">
        <Card className="p-6">
          <h2 className="orx-text-xl orx-font-bold mb-2">Primeira Seção</h2>
          <p className="text-[var(--orx-text-secondary)]">Conteúdo da primeira seção.</p>
        </Card>
      </Section>
      <Section padding="md">
        <Card className="p-6">
          <h2 className="orx-text-xl orx-font-bold mb-2">Segunda Seção</h2>
          <p className="text-[var(--orx-text-secondary)]">Conteúdo da segunda seção.</p>
        </Card>
      </Section>
      <Section padding="md">
        <Card className="p-6">
          <h2 className="orx-text-xl orx-font-bold mb-2">Terceira Seção</h2>
