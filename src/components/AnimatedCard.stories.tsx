    ...
    children: (
      <div className="p-6 min-w-[300px]">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <p className="text-sm text-[var(--orx-text-secondary)]">Receita Mensal</p>
            <p className="text-2xl font-bold text-[var(--orx-text-primary)]">R$ 45.280</p>
          </div>
        </div>
        <p className="text-sm text-[var(--orx-success)]">+12.5% vs mês anterior</p>
      </div>
    ),
  },
};
    ...
    <div className="grid grid-cols-3 gap-4">
      <AnimatedCard animation="slideUp" hoverEffect="lift" delay={0}>
        <div className="p-6">
          ...
          <h3 className="font-semibold mb-1">1.284</h3>
          <p className="text-sm text-[var(--orx-text-secondary)]">Usuários Ativos</p>
        </div>
      </AnimatedCard>
      <AnimatedCard animation="slideUp" hoverEffect="lift" delay={100}>
        <div className="p-6">
          <DollarSign size={32} className="text-[var(--orx-success)] mb-3" />
          <h3 className="font-semibold mb-1">R$ 125.4K</h3>
          <p className="text-sm text-[var(--orx-text-secondary)]">Faturamento</p>
        </div>
      </AnimatedCard>
      <AnimatedCard animation="slideUp" hoverEffect="lift" delay={200}>
        <div className="p-6">
          <TrendingUp size={32} className="text-[var(--orx-info)] mb-3" />
          <h3 className="font-semibold mb-1">+18.2%</h3>
          <p className="text-sm text-[var(--orx-text-secondary)]">Crescimento</p>
        </div>
      </AnimatedCard>
    </div>
  ),
