...
export const Default: Story = {
  args: {
    children: (
      <Card className="p-6">
        <h2 className="orx-text-2xl orx-orx-font-bold mb-4">Container Padrão</h2>
...
export const LargeWidth: Story = {
  args: {
    children: (
      <Card className="p-6">
        <h2 className="orx-text-2xl orx-orx-font-bold mb-4">Container 7xl</h2>
        <p className="text-[var(--orx-text-secondary)]">
...
export const NoPadding: Story = {
  args: {
    children: (
      <Card className="p-6">
        <h2 className="orx-text-2xl orx-orx-font-bold mb-4">Sem Padding</h2>
        <p className="text-[var(--orx-text-secondary)]">
  ...
  args: {
    children: (
      <Card className="p-6 orx-animate-fade-in">
        <h2 className="orx-text-2xl orx-orx-font-bold mb-4">Com Animação</h2>
        <p className="text-[var(--orx-text-secondary)]">
  ...
  args: {
    children: (
      <div className="space-y-4">
        <Card className="p-6">
          <h2 className="orx-text-2xl orx-orx-font-bold mb-4">Container Principal</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="p-4 neuro-inset">
              <h3 className="orx-orx-font-semibold mb-2">Seção 1</h3>
              <p className="orx-text-sm text-[var(--orx-text-secondary)]">Conteúdo aninhado</p>
            </Card>
            <Card className="p-4 neuro-inset">
              <h3 className="orx-orx-font-semibold mb-2">Seção 2</h3>
              <p className="orx-text-sm text-[var(--orx-text-secondary)]">Conteúdo aninhado</p>
            </Card>
          </div>
        </Card>
