      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={cn("relative inline-flex items-center gap-2 px-6 py-2.5 rounded-lg","orx-orx-font-medium text-body-sm transition-all duration-200","focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary",
              isActive
