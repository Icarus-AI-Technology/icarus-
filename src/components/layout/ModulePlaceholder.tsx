      ...
      <div className="neumorphic-card p-12 max-w-2xl w-full text-center">
        ...
        {typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('qa') === '1' && (
          <div className="text-left" style={{ marginTop: '1.5rem' }}>
            <form aria-label="Filtros QA" style={{
              ...
              <div>
                <label htmlFor="qa-busca-generic" style={{ fontSize: '0.75rem', color: 'var(--orx-text-secondary)' }}>Busca</label>
                <input id="qa-busca-generic" name="busca" placeholder="Buscar..." style={{ width: '100%', padding: '0.5rem 0.75rem', borderRadius: '0.75rem' }} />
              </div>
              <div>
                <label htmlFor="qa-inicio-generic" style={{ fontSize: '0.75rem', color: 'var(--orx-text-secondary)' }}>Início</label>
                <input id="qa-inicio-generic" name="inicio" type="date" style={{ width: '100%', padding: '0.5rem 0.75rem', borderRadius: '0.75rem' }} />
              </div>
              <div>
                <label htmlFor="qa-fim-generic" style={{ fontSize: '0.75rem', color: 'var(--orx-text-secondary)' }}>Fim</label>
                <input id="qa-fim-generic" name="fim" type="date" style={{ width: '100%', padding: '0.5rem 0.75rem', borderRadius: '0.75rem' }} />
              </div>
              <div>
                <label htmlFor="qa-status-generic" style={{ fontSize: '0.75rem', color: 'var(--orx-text-secondary)' }}>Status</label>
                <select id="qa-status-generic" name="status" style={{ width: '100%', padding: '0.5rem 0.75rem', borderRadius: '0.75rem' }}>
              ...
              <div style={{ gridColumn: '1 / -1', display: 'flex', gap: '0.5rem' }}>
                <button type="submit" className="neumorphic-button" aria-label="Aplicar filtros" style={{ padding: '0.5rem 0.75rem', borderRadius: '0.75rem' }}>Aplicar</button>
                <button type="button" className="neumorphic-button" aria-label="Limpar filtros" style={{ padding: '0.5rem 0.75rem', borderRadius: '0.75rem' }}>Limpar</button>
              </div>
            </form>

            <div className="neumorphic-container" style={{ padding: '1rem', borderRadius: '1rem' }}>
              <h2 style={{ fontSize: '0.813rem', fontWeight: 600, color: 'var(--orx-text-primary)', marginBottom: '0.75rem' }}>Registros (QA)</h2>
