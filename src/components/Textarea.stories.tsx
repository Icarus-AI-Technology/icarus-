...
export const AllVariants: Story = {
  render: () => (
    <div className="flex flex-col gap-4 p-6 bg-[var(--bg-primary)] rounded-2xl neuro-raised w-[500px]">
      ...
      <Textarea label="Com limite" placeholder="Máximo de 100 caracteres" maxLength={100} />
      <Textarea label="Com erro" error="Este campo é obrigatório" placeholder="Digite algo" />
