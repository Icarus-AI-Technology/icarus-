  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          <div
            className="text-[var(--orx-text-secondary)] mb-1 text-[0.813rem]"
          >
            {title}
          </div>
          <div
            className="text-[var(--orx-text-primary)] font-bold"
          >
            {value}
          </div>
          {hint && (
            <div
              className="mt-1 text-[var(--orx-text-muted)] text-[0.75rem]"
            >
              {hint}
            </div>
          )}
