...
export const SubModulesNavigation: React.FC<SubModulesNavigationProps> = ({
  ...
  return (
    <div className={cn("w-full", className)}>
      <h3 className="text-body-lg text-primary dark:text-gray-100 mb-4" style={{ fontWeight: 500 }}>
        {title}
      </h3>
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-primary dark:text-gray-100 mb-1" style={{ fontWeight: 500 }}>
                    {subModule.label}
                  </h4>
