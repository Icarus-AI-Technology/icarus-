...
export const Tabs: React.FC<TabsProps> = ({
  ...
  return (
    <div className={cn(variant === 'horizontal' ? 'flex flex-col' : 'flex gap-6', className)}>
      {/* Tab List */}
      <div
        className={cn(
          'relative',
          ...
          'rounded-lg',
          variant === 'horizontal'
            ? 'p-1 flex gap-1 overflow-x-auto'
            : 'p-2 flex flex-col gap-1 min-w-[160px] md:min-w-[200px]'
        )}
        role="tablist"
      ...
      <div
        ...
        className={cn('flex-1', variant === 'horizontal' ? 'mt-4' : '')}
      >
        {activeContent}
      </div>
    </div>
