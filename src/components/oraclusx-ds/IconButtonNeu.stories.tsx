    ...
    <div className="flex flex-col gap-6 p-6 bg-[var(--bg-primary)] rounded-2xl neuro-raised">
      <div>
        ...
        <div className="flex items-end gap-3">
          ...
          <IconButtonNeu icon={<Heart className="w-6 h-6" />} size="lg" aria-label="Grande" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex gap-3">
          ...
          <IconButtonNeu icon={<Share2 className="w-5 h-5" />} aria-label="Compartilhar" />
          <IconButtonNeu icon={<Heart className="w-5 h-5" />} aria-label="Favoritar" />
        </div>
      </div>
