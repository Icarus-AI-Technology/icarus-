...
export const Default: Story = {
  args: {
    children: (
      <div>
        <h3 className="orx-text-lg orx-font-semibold mb-2">Card Padrão</h3>
...
export const Elevated: Story = {
  args: {
    ...
    children: (
      <div>
        <h3 className="orx-text-lg orx-font-semibold mb-2">Card Elevado</h3>
...
export const Pressed: Story = {
  args: {
    ...
    children: (
      <div>
        <h3 className="orx-text-lg orx-font-semibold mb-2">Card Pressionado</h3>
...
export const SmallPadding: Story = {
  args: {
    ...
    children: (
      <div>
        <h3 className="orx-text-sm orx-font-semibold">Padding Pequeno</h3>
      </div>
    ),
  },
};
...
export const LargePadding: Story = {
  args: {
    ...
    children: (
      <div>
        <h3 className="orx-text-xl orx-font-semibold mb-3">Padding Grande</h3>
