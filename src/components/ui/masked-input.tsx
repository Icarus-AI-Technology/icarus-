...
export const MaskedInput = forwardRef<HTMLInputElement, MaskedInputProps>(
  (
    ...
    const showSuccess = showValidation && isTouched && isValid && value.length > 0;
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              ...
              // Estados
              showError && 'border-[var(--orx-error)] focus:ring-[var(--orx-error)]',
              showSuccess && 'border-[var(--orx-success)] focus:ring-[var(--orx-success)]',
              className
            )}
            {...props}
          />
