  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--orx-primary)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        destructive: 'bg-[var(--orx-error)] text-white shadow-sm hover:bg-[var(--orx-error-dark)]',
        outline:
        ...
        // Semantic variants
        success: 'bg-[var(--orx-success)] text-white shadow-sm hover:bg-[var(--orx-success-dark)]',
        warning: 'bg-[var(--orx-warning)] text-white shadow-sm hover:bg-[var(--orx-warning-dark)]',
      ...
      size: {
        ...
        xl: 'h-14 rounded-lg px-10 orx-text-lg',
        icon: 'h-10 w-10',
      },
    },
    defaultVariants: {
