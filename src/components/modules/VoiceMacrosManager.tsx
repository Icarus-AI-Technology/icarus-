...
export default function VoiceMacrosManager(): JSX.Element {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="orx-text-xl orx-font-semibold mb-2">Voice Macros</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="orx-text-2xl orx-font-semibold">42</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><CardTitle className="orx-text-base">Uso/dia</CardTitle></CardHeader>
          <CardContent>
            <div className="orx-text-2xl orx-font-semibold">312</div>
          </CardContent>
        </Card>
        <Card>
