    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="px-4 py-2 rounded-xl neuro-raised">
          <span className="text-body-sm text-[var(--text-primary)] orx-font-medium">0 Leads</span>
          </div>
        </div>
        ...
        <Card className="neuro-raised p-12 text-center">
          ...
          <h3 className="text-heading-sm text-[var(--text-primary)] mb-2 orx-font-medium">Gestão de Leads</h3>
