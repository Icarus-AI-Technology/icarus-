...
export default function SystemHealthDashboard(): JSX.Element {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-xl font-semibold mb-2">System Health Dashboard</h1>
      <p className="text-sm text-muted-foreground mb-4">Saúde do sistema, uptime e métricas de latência.</p>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base">Erro (5xx)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-semibold">0.42%</div>
            <div className="text-xs text-muted-foreground">p95 últimas 24h</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base">Latência p95</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-semibold">312 ms</div>
            <div className="text-xs text-muted-foreground">/api/ml/vector-search</div>
          </CardContent>
        </Card>
      </div>
