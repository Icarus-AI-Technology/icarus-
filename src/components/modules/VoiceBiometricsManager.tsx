...
export default function VoiceBiometricsManager(): JSX.Element {
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-muted-foreground mb-4">Gestão de amostras de voz e verificação biométrica.</p>

      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-base">Perfis cadastrados</CardTitle></CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-base">Taxa de match</CardTitle></CardHeader>
          <CardContent>
            <Badge variant="default">98.1%</Badge>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-base">Tentativas falhas</CardTitle></CardHeader>
          <CardContent>
