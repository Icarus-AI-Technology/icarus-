    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          <div>
            <h1 className="text-heading-lg font-display text-[var(--text-primary)] mb-2">Integrações Externas IA</h1>
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-[var(--primary)] rounded-full">
            ...
            <div className="text-left">
              <p className="text-[var(--primary-foreground)] text-body-sm" style={{ fontWeight: 500 }}>IA Monitoramento</p>
