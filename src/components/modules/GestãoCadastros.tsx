            ...
            <table className="w-full">
              <thead className="border-b border-[var(--border)]">
                <tr>
                  ...
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">CRM</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Especialidade</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Hospital</th>
                  ...
                  >
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[var(--text-primary)] orx-font-medium">{medico.nome}</span>
                      </div>
                    </td>
                    <td className="p-4 text-[var(--text-primary)]">{medico.crm}</td>
                    <td className="p-4">
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-body-xs bg-accent/10 text-accent orx-font-medium">
                    ...
                    <td className="p-4">
                      <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-body-xs orx-font-medium ${getStatusColor(medico.status)}`}>
                        {medico.status}
                      </span>
                    </td>
                    <td className="p-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="border-b border-[var(--border)]">
                <tr>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Nome</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">CNPJ</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Cidade/UF</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Tipo</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Contato</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Status</th>
                  <th className="text-left p-4 text-body-sm text-[var(--text-secondary)] orx-font-medium">Ações</th>
                </tr>
                  ...
                  >
                    <td className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[var(--text-primary)] orx-font-medium">{hospital.nome}</span>
                      </div>
                    </td>
                    ...
                    <td className="p-4">
                      <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-body-xs orx-font-medium ${getStatusColor(hospital.status)}`}>
                        {hospital.status}
                      </span>
                    </td>
                    <td className="p-4">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="px-4 py-2 rounded-xl neuro-raised flex items-center gap-2">
            ...
            <span className="text-body-sm text-[var(--text-primary)] orx-font-medium">IA: 99.2% precisão</span>
          </div>
        </div>
