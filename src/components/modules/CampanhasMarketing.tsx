...
export function CampanhasMarketing(): JSX.Element {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="orx-text-xl orx-font-semibold mb-2">Campanhas de Marketing</h1>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="orx-text-2xl orx-font-semibold">7</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="orx-text-2xl orx-font-semibold">3.8%</div>
