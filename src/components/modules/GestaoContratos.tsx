        ...
        {dashboardData.map((card) => (
          <Card key={card.id} className="neuro-raised h-full">
            <CardHeader className="flex-row items-start justify-between gap-4">
              <div>
                <CardTitle className="text-[var(--text-primary)] text-body-sm font-medium">
                  {card.label}
                </CardTitle>
      ...
      columns={[
        {
          ...
          cell: ({ row }) => (
            <div className="space-y-1">
              <p className="text-body-sm text-[var(--text-primary)] font-medium">{row.titulo}</p>
      ...
      {contratosVencendo.map((contrato) => (
        <Card key={contrato.id} className="neuro-raised">
          <CardContent className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-4">
            <div>
              <p className="text-body-sm text-[var(--text-primary)] font-medium">{contrato.titulo}</p>
            ...
            <div className="space-y-4">
              {clausulas.map((clausula) => (
                <div key={clausula.id} className="p-4 rounded-lg neuro-inset">
                  <p className="text-body-sm text-[var(--text-primary)] font-medium">{clausula.titulo}</p>
        ...
        {[
          ...
          <Card key={item.id} className="neuro-inset">
            <CardContent className="pt-6">
              <p className="text-body-sm text-[var(--text-primary)] font-medium">{item.label}</p>
