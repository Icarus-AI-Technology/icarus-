...
export const ManutencaoFrota: React.FC = () => {
    ...
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          <div><h1 className="text-heading-lg font-display text-primary dark:text-gray-100 mb-2">Manutenção Frota IA</h1><p className="text-secondary dark:text-muted">Sistema IA</p></div>
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full"><Settings className="text-inverse animate-spin-slow" size={20} /><div className="text-left"><p className="text-inverse text-body-sm" style={{ fontWeight: 500 }}>IA</p><p className="text-indigo-100 text-body-xs">97.3%</p></div></div>
        </header>
        ...
        <Card><CardHeader><CardTitle>Manutenção Frota IA</CardTitle></CardHeader><CardContent><div className="text-center py-12"><Wrench size={64} className="mx-auto text-muted mb-4" /><p className="text-secondary dark:text-muted">Módulo IA</p></div></CardContent></Card>
      </div>
    </div>
  );
};
