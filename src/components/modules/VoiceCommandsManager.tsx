...
export default function VoiceCommandsManager(): JSX.Element {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-xl font-semibold mb-2">Voice Commands</h1>
      <p className="text-sm text-muted-foreground mb-4">Gerenciamento de comandos e atalhos por voz.</p>

      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-base">Comandos ativos</CardTitle></CardHeader>
          <CardContent>
            <div className="text-2xl font-semibold">85</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-base">Ações executadas</CardTitle></CardHeader>
          <CardContent>
