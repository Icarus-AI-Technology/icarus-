...
import { Brain, Users, TrendingUp, Award, Settings } from 'lucide-react';
export const CapacitacaoIA: React.FC = () => {
  const [a, setA] = useState('geral');
  const cats = [
    { id: 'geral', label: 'Geral', icon: Brain, count: 124, trend: '+15' },
    { id: 'det', label: 'Detalhes', icon: Users, count: 89, trend: '+8' },
    { id: 'ana', label: 'Analytics', icon: TrendingUp, count: 56, trend: '+12' },
    { id: 'cfg', label: 'Config', icon: Award, count: 34, trend: '+5' },
  ];
  const kpis = [
    { title: 'Total', value: '303', trend: '+40', icon: Brain, color: 'blue' },
    { title: 'Taxa', value: '98.3%', trend: '+2%', icon: Users, color: 'green' },
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Capacitação IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Brain size={64} className="mx-auto text-muted mb-4" />
              <p className="text-secondary dark:text-muted">Módulo profissional IA</p>
            </div>
          </CardContent>
        </Card>
      </div>
