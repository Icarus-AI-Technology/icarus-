...
import { DollarSign, TrendingUp, Users, BarChart3, Settings } from 'lucide-react';
export const AnunciosPagos: React.FC = () => {
  const [a, s] = useState('g');
  const c = [
    { id: 'g', label: 'Geral', icon: DollarSign, count: 124, trend: '+15' },
  ...
  const k = [
    { title: 'Total', value: '303', trend: '+40', icon: DollarSign, color: 'blue' },
    { title: 'Taxa', value: '97.4%', trend: '+2%', icon: TrendingUp, color: 'green' },
    { title: 'IA', value: '97.4%', trend: 'on', icon: Settings, color: 'indigo' },
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-body-xs">97.4%</p>
            </div>
          </div>
        </header>
        <div className="mb-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Anúncios Pagos IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <DollarSign size={64} className="mx-auto text-muted mb-4" />
