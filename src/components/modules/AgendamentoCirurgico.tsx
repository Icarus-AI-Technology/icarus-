...
import { Calendar, Clock, CheckCircle, Users, Settings, TrendingUp, AlertCircle } from"lucide-react";
    ...
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          <div>
            <h1 className="text-heading-lg font-display text-primary dark:text-gray-100 mb-2">Agendamento Cirúrgico IA</h1>
            <p className="text-secondary dark:text-muted">Calendário inteligente com detecção de conflitos</p>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div className="text-left">
              <p className="text-inverse text-body-sm" style={{ fontWeight: 500 }}>IA Otimização</p>
