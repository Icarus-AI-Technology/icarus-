...
export default function Microsoft365IntegrationPanel() {
  ...
  const [novaReuniao, setNovaReuniao] = useState({
    ...
    data_inicio: '',
    data_fim: '',
    participantes: [] as Array<{ email: string; nome: string; tipo: 'required' | 'optional' }>,
  ...
  const criarReuniaoExemplo = async () => {
    const reuniao: TeamsReuniao = {
      ...
      participantes: [
        { email: 'compras@hospitalxyz.com.br', nome: 'Gerente de Compras', tipo: 'required' },
        { email: 'medico@hospitalxyz.com.br', nome: 'Dr. João Silva', tipo: 'optional' },
      ],
      lembrete_minutos: 30,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="mb-2 text-[0.813rem] orx-orx-font-bold">Microsoft 365</h1>
            ...
            <div className="flex items-center gap-2 neuro-raised px-4 py-2 rounded-lg">
              ...
              <span className="text-[0.813rem] orx-orx-font-medium">Conectado</span>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <Card className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-[0.813rem] orx-orx-font-semibold">Próximas Reuniões</h2>
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={() => setShowFormularioReuniao(!showFormularioReuniao)}
                    className="px-4 py-2 rounded-lg bg-[var(--orx-primary)] text-white hover:bg-[var(--orx-primary-hover)] transition-all flex items-center gap-2"
                  >
                    <Plus size={18} />
                    Nova Reunião
              ...
              {showFormularioReuniao && (
                <div className="mb-6 p-6 neuro-inset rounded-xl space-y-4">
                  ...
                  <input
                    ...
                    onChange={(e) => setNovaReuniao({ ...novaReuniao, assunto: e.target.value })}
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      >
                        ...
                        <span className="text-[0.813rem] orx-orx-font-medium">Hospital</span>
                      </button>
                      <button
                        type="button"
                        onClick={() =>
                      ...
                      >
                        ...
                        <span className="text-[0.813rem] orx-orx-font-medium">Plano de Saúde</span>
                      </button>
                      <button
                        type="button"
                        onClick={() =>
                      ...
                      >
                        ...
                        <span className="text-[0.813rem] orx-orx-font-medium">Indústria</span>
                      </button>
                    </div>
                  </div>
                  ...
                  {novaReuniao.entidade_tipo && (
                    <div>
                      ...
                      >
                        ...
                        {novaReuniao.entidade_tipo === 'hospital' && (
                          <>
                            <option value="apresentacao_produto">Apresentação de Produto</option>
                            <option value="negociacao">Negociação Comercial</option>
                        ...
                        {novaReuniao.entidade_tipo === 'plano_saude' && (
                          <>
                            <option value="negociacao">Negociação de Tabela</option>
                            <option value="credenciamento">Credenciamento</option>
                            <option value="auditoria">Auditoria de Contas</option>
                            <option value="comercial">Apresentação Comercial</option>
                          </>
                        )}
                        {novaReuniao.entidade_tipo === 'industria' && (
                          <>
                            <option value="negociacao">Negociação de Compra</option>
                            <option value="apresentacao_produto">Apresentação de Linha</option>
                            <option value="treinamento">Treinamento Técnico</option>
                            <option value="comercial">Proposta de Distribuição</option>
                            <option value="qualidade">Qualidade/Certificações</option>
                          </>
                        )}
                      </select>
                    </div>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h3 className="mb-1 orx-orx-font-semibold">{reuniao.subject}</h3>
        ...
        {activeTab !== 'teams' && (
          <Card className="p-8 text-center">
            ...
            <h3 className="mb-2 text-[0.813rem] orx-orx-font-semibold">Em Desenvolvimento</h3>
            <p className="text-[var(--text-secondary)]">
