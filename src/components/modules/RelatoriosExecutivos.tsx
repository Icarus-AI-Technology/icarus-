      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-start justify-between">
          ...
          <div className="px-4 py-2 rounded-xl neuro-raised flex items-center gap-2">
            ...
            <span className="text-body-sm text-[var(--text-primary)] orx-font-medium">C-Level</span>
          </div>
        </div>
        ...
        <Card className="neuro-raised p-12 text-center">
          ...
          <h3 className="text-heading-sm text-[var(--text-primary)] mb-2 orx-font-medium">Relatórios Executivos</h3>
