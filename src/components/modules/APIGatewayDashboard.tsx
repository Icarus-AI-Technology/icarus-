            ...
            {kpis.map((kpi) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="opacity-80 text-[0.813rem] orx-orx-font-medium">{kpi.title}</h3>
                  <kpi.icon className="w-5 h-5 opacity-80" />
                </div>
                <div className="mt-4 text-[0.813rem] orx-orx-font-bold">{kpi.value}</div>
      ...
      {alerts.filter((alert) => !alert.is_resolved && alert.severidade === 'critica').length >
        ...
        <Card className="p-4 neuro-inset bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700">
          <div className="flex items-center gap-3 text-red-700 dark:text-red-300">
            ...
            <h4 className="orx-orx-font-medium">Alertas Críticos</h4>
          </div>
          ...
          <TableBody>
            {metrics.map((metric) => (
              <TableRow key={metric.endpoint_id}>
                <TableCell className="orx-orx-font-medium">{metric.endpoint_nome}</TableCell>
                <TableCell>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="mb-1 text-[0.813rem] orx-orx-font-medium">{alert.mensagem}</p>
        ...
        <Card className="p-6 neuro-raised">
          ...
          <div className="space-y-3">
            ...
            {endpointsWarning > 0 && (
              <div className="p-4 neuro-inset rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[0.813rem] orx-orx-font-medium">Meio-Abertos (Teste)</span>
            ...
            {endpointsDown > 0 && (
              <div className="p-4 neuro-inset rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[0.813rem] orx-orx-font-medium">Abertos (Offline)</span>
