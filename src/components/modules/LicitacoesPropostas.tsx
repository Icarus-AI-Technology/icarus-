...
export default function LicitacoesPropostas() {
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="p-6 neuro-raised bg-gradient-to-br from-blue-500 to-blue-600 text-white">
            <div className="flex items-center justify-between mb-3">
              <h3 className="opacity-90 text-[0.813rem] orx-font-medium">Licitações Ativas</h3>
              <FileText className="w-5 h-5 opacity-80" />
            </div>
            <p className="text-[0.813rem] orx-font-bold">{licitacoesAbertas}</p>
          ...
          <Card className="p-6 neuro-raised bg-gradient-to-br from-orange-500 to-orange-600 text-white">
            <div className="flex items-center justify-between mb-3">
              <h3 className="opacity-90 text-[0.813rem] orx-font-medium">Propostas Pendentes</h3>
              <Clock className="w-5 h-5 opacity-80" />
            </div>
            <p className="text-[0.813rem] orx-font-bold">{propostasPendentes}</p>
          ...
          <Card className="p-6 neuro-raised bg-gradient-to-br from-emerald-500 to-emerald-600 text-white">
            ...
            <p className="text-[0.813rem] orx-font-bold">{taxaSucesso?.taxa_sucesso.toFixed(1)}%</p>
          ...
          <Card className="p-6 neuro-raised bg-gradient-to-br from-purple-500 to-purple-600 text-white">
            <div className="flex items-center justify-between mb-3">
              <h3 className="opacity-90 text-[0.813rem] orx-font-medium">Valor Vencido (Ano)</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6 neuro-raised">
            <h3 className="mb-4 text-[0.813rem] orx-font-semibold">Performance (Últimos 12 meses)</h3>
          ...
          {/* Próximas Aberturas */}
          <Card className="p-6 neuro-raised">
            <h3 className="mb-4 text-[0.813rem] orx-font-semibold">Próximas Aberturas</h3>
              ...
              {licitacoes.slice(0, 5).map((lic) => (
                ...
                >
                  <div className="flex-1">
                    <p className="text-[0.813rem] orx-font-semibold">{lic.titulo}</p>
  ...
  const renderLicitacoes = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-[0.813rem] orx-font-semibold">Licitações Ativas</h2>
            ...
            {licitacoes.map((lic) => {
              ...
              return (
                <TableRow key={lic.id}>
                  ...
                  <TableCell>
                    <div>
                      <p className="orx-font-medium">{lic.titulo}</p>
  ...
  const renderPropostas = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-[0.813rem] orx-font-semibold">Propostas Pendentes de Aprovação</h2>
      </div>
      ...
      <div className="space-y-4">
        {propostas.map((prop) => (
          <Card key={prop.id} className="p-6 neuro-raised">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-[0.813rem] orx-font-semibold">{prop.numero_proposta}</h3>
                  <Badge
                    variant="default"
                    className={
              ...
              <div className="text-right">
                <p className="text-[0.813rem] orx-font-bold">{formatCurrency(prop.valor_total)}</p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-[var(--text-secondary)]/20">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <p className="text-[0.813rem] orx-font-medium">Comercial</p>
                  {prop.aprovada_comercial ? (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <p className="text-[0.813rem] orx-font-medium">Financeiro</p>
                  {prop.aprovada_financeiro ? (
                    <ThumbsUp className="w-5 h-5 text-success" />
                  ) : (
                    <Clock className="w-5 h-5 text-[var(--text-secondary)]" />
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <p className="text-[0.813rem] orx-font-medium">Diretoria</p>
                  {prop.aprovada_diretoria ? (
                    <ThumbsUp className="w-5 h-5 text-success" />
                  ) : (
                    <Clock className="w-5 h-5 text-[var(--text-secondary)]" />
            ...
            <div className="mt-4">
              <div className="flex items-center justify-between mb-2">
                <p className="text-[0.813rem] orx-font-medium">Progresso de Aprovação</p>
                <p className="text-[var(--text-secondary)] text-[0.813rem]">
