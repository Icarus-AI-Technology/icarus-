...
export const FolhaPagamento: React.FC = () => {
  ...
  const cats = [
    { id: 'geral', label: 'Geral', icon: DollarSign, count: 124, trend: '+15' },
    { id: 'det', label: 'Detalhes', icon: Users, count: 89, trend: '+8' },
    { id: 'ana', label: 'Analytics', icon: Calculator, count: 56, trend: '+12' },
    { id: 'cfg', label: 'Config', icon: FileText, count: 34, trend: '+5' },
  ];
  const kpis = [
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Folha Pagamento IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <DollarSign size={64} className="mx-auto text-muted mb-4" />
              <p className="text-secondary dark:text-muted">Módulo financeiro IA</p>
            </div>
          </CardContent>
        </Card>
      </div>
