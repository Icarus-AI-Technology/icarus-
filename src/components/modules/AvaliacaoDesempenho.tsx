...
import { Award, Users, TrendingUp, BarChart3, Settings } from 'lucide-react';
export const AvaliacaoDesempenho: React.FC = () => {
  const [a, setA] = useState('geral');
  const cats = [
    { id: 'geral', label: 'Geral', icon: Award, count: 124, trend: '+15' },
  ...
  const kpis = [
    { title: 'Total', value: '303', trend: '+40', icon: Award, color: 'blue' },
    { title: 'Taxa', value: '98.4%', trend: '+2%', icon: Users, color: 'green' },
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div className="text-left">
              ...
              <p className="text-indigo-100 text-body-xs">98.4%</p>
            </div>
          </div>
        </header>
        <div className="mb-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Avaliação Desempenho IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Award size={64} className="mx-auto text-muted mb-4" />
              <p className="text-secondary dark:text-muted">Módulo métricas IA</p>
            </div>
          </CardContent>
        </Card>
      </div>
