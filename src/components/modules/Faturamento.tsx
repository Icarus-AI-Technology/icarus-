...
export default function Faturamento() {
  ...
  const renderDashboard = () => (
    <div className="space-y-6">
      ...
      {!loading && (
        <Card className="neuro-raised p-6">
          <h3 className="text-body-lg text-[var(--text-primary)] mb-4 orx-font-medium">
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between text-body-sm mb-1">
                ...
                <span className="text-[var(--text-primary)] orx-font-medium">
              ...
              <tbody>
                {faturas.map((fatura) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-[var(--text-primary)] orx-font-medium">
                      {formatCurrency(fatura.valor_total)}
                    </td>
                    <td className="p-4">
                      <span
                        className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-body-xs orx-font-medium ${getStatusColor(fatura.status)}`}
                      >
