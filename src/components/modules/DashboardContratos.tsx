        ...
        <header className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div className="text-left">
              <p className="text-inverse text-body-sm orx-orx-font-medium">IA Analytics</p>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-body-sm orx-orx-font-medium">94.7%</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-body-sm orx-orx-font-medium">91.2%</span>
                  </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {['Renovação prioritária', 'Oportunidade upsell', 'Risco de churn'].map(
                  (insight, i) => (
