...
import { UserCheck, Rocket, CheckCircle, Users, Settings, TrendingUp } from 'lucide-react';
export const OnboardingDigital: React.FC = () => {
  const [a, setA] = useState('geral');
  const cats = [
    { id: 'geral', label: 'Geral', icon: UserCheck, count: 124, trend: '+15' },
    { id: 'det', label: 'Detalhes', icon: Rocket, count: 89, trend: '+8' },
    { id: 'ana', label: 'Analytics', icon: CheckCircle, count: 56, trend: '+12' },
    { id: 'cfg', label: 'Config', icon: Users, count: 34, trend: '+5' },
  ];
  const kpis = [
    { title: 'Total', value: '303', trend: '+40', icon: UserCheck, color: 'blue' },
    { title: 'Taxa', value: '97.9%', trend: '+2%', icon: Rocket, color: 'green' },
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div className="text-left">
              ...
              <p className="text-indigo-100 text-body-xs">97.9%</p>
            </div>
          </div>
        </header>
        <div className="mb-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Onboarding Digital IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <UserCheck size={64} className="mx-auto text-muted mb-4" />
              <p className="text-secondary dark:text-muted">Módulo integração IA</p>
            </div>
          </CardContent>
        </Card>
      </div>
...
export default OnboardingDigital;
