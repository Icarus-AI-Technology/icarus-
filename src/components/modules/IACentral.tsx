    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-start justify-between">
          ...
          <span className="text-body-sm text-[var(--text-primary)] orx-orx-font-medium">Online</span>
          </div>
        </div>
        ...
        <Card className="neuro-raised p-12 text-center">
          ...
          <h3 className="text-heading-sm text-[var(--text-primary)] mb-2 orx-orx-font-medium">IA Central</h3>
