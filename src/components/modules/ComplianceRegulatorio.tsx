  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div className="text-left">
              ...
              <p className="text-indigo-100 text-body-xs">98.6%</p>
            </div>
          </div>
        </header>
        <div className="mb-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Compliance Regulatório IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Shield size={64} className="mx-auto text-muted mb-4" />
