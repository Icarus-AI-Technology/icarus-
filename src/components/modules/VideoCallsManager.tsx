...
export default function VideoCallsManager(): JSX.Element {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-xl font-semibold mb-2">Video Calls</h1>
      <p className="text-sm text-muted-foreground mb-4">Gerenciamento e métricas de videochamadas.</p>

      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-base">Reuniões hoje</CardTitle></CardHeader>
          <CardContent>
            <div className="text-2xl font-semibold">19</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-base">Duração média</CardTitle></CardHeader>
          <CardContent>
            <div className="text-2xl font-semibold">28m</div>
          </CardContent>
        </Card>
        <Card>
