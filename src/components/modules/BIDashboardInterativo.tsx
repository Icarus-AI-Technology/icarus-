...
export function BIDashboardInterativo() {
        ...
        {kpis.map((kpi, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              <h3 className="opacity-90 text-[0.813rem] orx-font-medium">{kpi.title}</h3>
              <kpi.icon className="w-6 h-6 opacity-80" />
            </div>
            <div className="mt-4">
              <p className="text-[0.813rem] orx-font-bold">{kpi.value}</p>
            ...
            {vendasPorProduto.slice(0, 5).map((produto, index) => (
              <div key={index} className="flex items-center justify-between p-3 neuro-flat rounded-lg">
                <div className="flex-1">
                  <p className="text-[0.813rem] orx-font-medium">{produto.descricao}</p>
                  <p className="text-[var(--text-secondary)] text-[0.813rem]">{produto.categoria}</p>
                </div>
                <div className="text-right">
                  <p className="text-[var(--primary)] orx-font-semibold">
        ...
        <Card className="p-6 neuro-raised">
          ...
          <div className="space-y-3">
            {vendasPorCliente.slice(0, 5).map((cliente, index) => (
              <div key={index} className="flex items-center justify-between p-3 neuro-flat rounded-lg">
                <div className="flex-1">
                  <p className="text-[0.813rem] orx-font-medium">{cliente.razao_social}</p>
                  <p className="text-[var(--text-secondary)] text-[0.813rem]">
  ...
  const renderProdutos = () => (
    <div className="space-y-6">
      <Card className="p-6 neuro-raised">
        <h3 className="mb-4 text-[0.813rem] orx-font-semibold">Análise de Produtos OPME</h3>
        <OrxBarChart
      ...
      <Card className="p-6 neuro-raised">
        <h3 className="mb-4 text-[0.813rem] orx-font-semibold">Distribuição por Categoria</h3>
        <OrxPieChart
          ...
          {performanceVendedores.map((vendedor, index) => (
            <div key={index} className="p-4 neuro-flat rounded-lg">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <p className="orx-font-semibold">{vendedor.nome}</p>
                  <p className="text-[var(--text-secondary)] text-[0.813rem]">{vendedor.equipe}</p>
                </div>
                <div className="text-right">
                  <p className="text-[var(--primary)] orx-font-bold">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[0.813rem]">
                  ...
                  <span className={`orx-font-semibold ${vendedor.atingimento_meta_percentual >= 100 ? 'text-success' : 'text-warning'}`}>
