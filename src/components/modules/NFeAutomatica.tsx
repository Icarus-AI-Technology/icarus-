...
import { FileText, Send, CheckCircle, Clock, Settings, TrendingUp, AlertTriangle } from"lucide-react";
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          <div>
            <h1 className="text-heading-lg font-display text-[var(--text-primary)] mb-2">NFe Automática IA</h1>
