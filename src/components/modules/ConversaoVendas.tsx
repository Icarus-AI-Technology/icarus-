...
export const ConversaoVendas: React.FC = () => {
  ...
  const k = [
    { title: 'Total', value: '303', trend: '+40', icon: TrendingUp, color: 'blue' },
    { title: 'Taxa', value: '99.2%', trend: '+2%', icon: DollarSign, color: 'green' },
    { title: 'IA', value: '99.2%', trend: 'on', icon: Settings, color: 'indigo' },
