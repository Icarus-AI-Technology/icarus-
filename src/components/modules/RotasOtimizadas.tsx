/**
 * Módulo: Rotas Otimizadas IA
 * Sistema inteligente com IA 98.7% precisão
 */

import React, { useState } from"react";
import { Card, CardHeader, CardTitle, CardDescription, CardContent, Badge } from"@/components/oraclusx-ds";
import { Route, MapPin, TrendingUp, Zap, Settings, TrendingUp } from"lucide-react";

export const RotasOtimizadas: React.FC = () => {
  const [activeCategory, setActiveCategory] = useState("geral");
  
  const categories = [
    { id:"geral", label:"Geral", icon: Route, count: 124, trend:"+15" },
  ...
  const kpis = [
    { title:"Total Registros", value:"303", trend:"+40", icon: Route, color:"blue" },
    { title:"Taxa Sucesso", value:"98.7%", trend:"+2.1%", icon: MapPin, color:"green" },
    { title:"IA Ativa", value:"98.7%", trend:"online", icon: Settings, color:"indigo" },
    ...
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          <div>
            <h1 className="text-heading-lg font-display text-[var(--text-primary)] mb-2">Rotas Otimizadas IA</h1>
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-[var(--primary)] rounded-full">
            ...
            <div className="text-left">
              ...
              <p className="text-[var(--primary-foreground)]/70 text-body-xs">98.7% precisão</p>
            </div>
          </div>
        </header>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Rotas Otimizadas IA</CardTitle>
            <CardDescription>Sistema em operação</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Route size={64} className="mx-auto text-muted mb-4" />
