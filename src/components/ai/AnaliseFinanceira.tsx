  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="orx-text-2xl orx-font-bold text-slate-900 dark:text-white">Análise Financeira IA</h2>
      ...
      {score && (
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h3 className="orx-text-lg orx-font-semibold text-slate-900 dark:text-white mb-1">
                {score.cliente_nome}
              </h3>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="orx-font-medium text-slate-900 dark:text-white mb-1">Recomendação IA</p>
        ...
        <div className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6">
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute -top-20 left-1/2 transform -translate-x-1/2 bg-slate-800 text-white orx-text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    <p className="orx-font-medium">{dia.data.split('-').slice(1).join('/')}</p>
                    ...
                    <p className="orx-font-bold">= R$ {(dia.saldo_previsto / 1000).toFixed(0)}k</p>
                  </div>
                </div>
              );
            })}
          ...
          <div className="mt-6 grid grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="orx-text-2xl orx-font-bold text-red-600">
            ...
            <div className="text-center">
              ...
              <p className={`orx-text-2xl orx-font-bold ${fluxoCaixa[fluxoCaixa.length - 1]?.saldo_previsto > 0 ? 'text-green-600' : 'text-red-600'}`}>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="orx-font-medium text-blue-900 dark:text-blue-200">Insights IA</p>
