  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="orx-text-2xl orx-font-bold text-slate-900 dark:text-white">Previsão de Estoque IA</h2>
      ...
      {error && (
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          <p className="orx-text-sm text-yellow-800 dark:text-yellow-200">{error}</p>
        </div>
      )}
        ...
        {previsoes.map((previsao) => (
          <div key={previsao.produto_id} className="bg-slate-50 dark:bg-slate-900 rounded-xl p-6 space-y-4">
            <div className="flex items-start justify-between">
              ...
              <div className={`
                flex items-center gap-1 px-3 py-1 rounded-full orx-text-sm orx-font-medium
            ...
            <div className="space-y-2">
              <p className="orx-text-xs orx-font-medium text-slate-600 dark:text-slate-400 uppercase">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-white dark:bg-slate-800 rounded-lg p-3">
                <p className="orx-text-xs text-slate-600 dark:text-slate-400">30 dias</p>
                <p className="orx-text-xl orx-font-bold text-slate-900 dark:text-white">
                  {previsao.demanda_prevista_30_dias}
                </p>
                <p className="orx-text-xs text-slate-500 dark:text-slate-500">unidades</p>
              </div>
              <div className="bg-white dark:bg-slate-800 rounded-lg p-3">
                <p className="orx-text-xs text-slate-600 dark:text-slate-400">60 dias</p>
                <p className="orx-text-xl orx-font-bold text-slate-900 dark:text-white">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-lg p-3">
                <p className="orx-text-xs text-slate-600 dark:text-slate-400">90 dias</p>
                <p className="orx-text-xl orx-font-bold text-slate-900 dark:text-white">
            ...
            {previsao.sazonalidade && (
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                <p className="orx-text-sm text-blue-800 dark:text-blue-200">
            ...
            {anomalias.map((anomalia, idx) => (
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h4 className="orx-font-semibold text-slate-900 dark:text-white">
                        {anomalia.produto_nome}
                      </h4>
                      <span className={`
                        px-2 py-0.5 rounded orx-text-xs orx-font-medium uppercase
                    ...
                    <p className="orx-text-sm text-slate-700 dark:text-slate-300 mb-2">
                      {anomalia.descricao}
                    </p>
                ...
                <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                  <p className="orx-text-sm orx-font-medium text-slate-700 dark:text-slate-300">
      ...
      {anomalias.length === 0 && (
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-6 text-center">
          ...
          <p className="orx-text-lg orx-font-semibold text-green-800 dark:text-green-200">
