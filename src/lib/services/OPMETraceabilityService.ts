...
export class OPMETraceabilityService {
          ...
          deviceInfo: {
            ...
            recallInfo: (d.recall as Record<string, unknown> | undefined)
              ? {
                  ...
                  recallNumber: (d.recall as Record<string, unknown>).recallNumber as
                    | string
                    | undefined,
                }
              : { isRecalled: false },
      ...
      if (response.success && response.data) {
        ...
        return {
          ...
          deviceInfo: {
            ...
            lotNumber: d.lotNumber as string | undefined,
            gtin: d.gtin as string | undefined,
            productName: (d.product as Record<string, unknown> | undefined)?.name as
              | string
              | undefined,
            productDescription: (d.product as Record<string, unknown> | undefined)?.description as
              | string
              | undefined,
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        return {
          success: true,
          verified:
            ((d.serialization as Record<string, unknown> | undefined)?.status as string) ===
            'verified',
          deviceInfo: {
            serialNumber: d.serialNumber as string,
            lotNumber: d.lotNumber as string | undefined,
            gtin: d.gtin as string | undefined,
            productName: (d.productInfo as Record<string, unknown> | undefined)?.tradeName as
              | string
              | undefined,
            productDescription: (d.productInfo as Record<string, unknown> | undefined)
              ?.description as string | undefined,
            manufacturer: 'Johnson & Johnson',
            manufacturingDate: (d.dates as Record<string, unknown> | undefined)?.manufactured as
              | string
              | undefined,
            expirationDate: (d.dates as Record<string, unknown> | undefined)?.expiration as
              | string
              | undefined,
            status: this.mapStatus(
              (d.serialization as Record<string, unknown> | undefined)?.status as string | undefined
            ),
            recallInfo: {
              isRecalled:
                ((d.recall as Record<string, unknown> | undefined)?.isActive as boolean) === true,
              recallDate: (d.recall as Record<string, unknown> | undefined)?.initiatedDate as
                | string
                | undefined,
              recallReason: (d.recall as Record<string, unknown> | undefined)?.reason as
                | string
                | undefined,
              recallNumber: (d.recall as Record<string, unknown> | undefined)?.identifier as
                | string
                | undefined,
            },
            // certifications omitted in stubbed typing
        ...
        return {
          ...
          deviceInfo: {
            ...
            productName: (d.product as Record<string, unknown> | undefined)?.name as
              | string
              | undefined,
            productDescription: (d.product as Record<string, unknown> | undefined)
              ?.fullDescription as string | undefined,
            ...
            recallInfo: {
              isRecalled:
                ((d.recall as Record<string, unknown> | undefined)?.active as boolean) === true,
              recallDate: (d.recall as Record<string, unknown> | undefined)?.date as
                | string
                | undefined,
              recallReason: (d.recall as Record<string, unknown> | undefined)?.description as
                | string
                | undefined,
            },
            // certifications omitted in stubbed typing
   ...
   */
  static async verifyBostonScientific(
    serialNumber: string,
    lotNumber?: string
  ): Promise<TraceabilityResult> {
    try {
      ...
      if (response.success && response.data) {
        ...
        return {
          success: true,
          verified:
            ((d.verificationResult as Record<string, unknown> | undefined)?.isValid as boolean) ===
            true,
          deviceInfo: {
            serialNumber: d.serialNumber as string,
            lotNumber: d.lotNumber as string | undefined,
            gtin: d.gtin as string | undefined,
            productName: (d.productInfo as Record<string, unknown> | undefined)?.name as
              | string
              | undefined,
            productDescription: (d.productInfo as Record<string, unknown> | undefined)
              ?.description as string | undefined,
            manufacturer: 'Boston Scientific',
            manufacturingDate: (d.dates as Record<string, unknown> | undefined)?.manufacturing as
              | string
              | undefined,
            expirationDate: (d.dates as Record<string, unknown> | undefined)?.expiration as
              | string
            ...
            recallInfo: {
              isRecalled:
                ((d.recallInfo as Record<string, unknown> | undefined)?.isActive as boolean) ===
                true,
              recallDate: (d.recallInfo as Record<string, unknown> | undefined)?.date as
                | string
                | undefined,
              recallReason: (d.recallInfo as Record<string, unknown> | undefined)?.reason as
                | string
                | undefined,
              recallNumber: (d.recallInfo as Record<string, unknown> | undefined)?.number as
                | string
                | undefined,
            },
            // certifications omitted in stubbed typing
  ...
  ): 'active' | 'recalled' | 'expired' | 'invalid' {
