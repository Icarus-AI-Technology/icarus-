...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      configuracoes_nfe: {
        Row: {
          ...
          token_sefaz: string | null;
          uf_sefaz: string | null;
          ultimo_numero_emitido: number | null;
          updated_at: string;
        };
        Insert: {
          ambiente?: string;
        ...
        Relationships: [
          {
            foreignKeyName: 'configuracoes_nfe_empresa_id_fkey';
            columns: ['empresa_id'];
            isOneToOne: false;
            referencedRelation: 'empresas';
            referencedColumns: ['id'];
      ...
      contratos: {
        Row: {
          ...
          id: string;
          indice_reajuste: Database['public']['Enums']['contrato_indice_enum'] | null;
          numero_contrato: string;
          observacoes: string | null;
          percentual_reajuste: number | null;
          periodicidade_reajuste: Database['public']['Enums']['contrato_periodicidade_enum'] | null;
          prazo_aviso_rescisao: number;
          renovacao_automatica: boolean;
          status: Database['public']['Enums']['contrato_status_enum'];
          tipo: Database['public']['Enums']['contrato_tipo_enum'];
          titulo: string;
          updated_at: string;
          valor_total: number;
        };
        Insert: {
          ...
          periodicidade_reajuste?:
            | Database['public']['Enums']['contrato_periodicidade_enum']
            | null;
          prazo_aviso_rescisao?: number;
          renovacao_automatica?: boolean;
          status?: Database['public']['Enums']['contrato_status_enum'];
      ...
      contratos_alertas: {
        Row: {
          ...
          severidade: Database['public']['Enums']['contrato_alerta_severidade_enum'];
          tipo: Database['public']['Enums']['contrato_alerta_tipo_enum'];
        };
        Insert: {
          contrato_id: string;
          created_at?: string;
        ...
        Relationships: [
          {
            foreignKeyName: 'contratos_alertas_contrato_id_fkey';
            columns: ['contrato_id'];
            isOneToOne: false;
            referencedRelation: 'contratos';
            referencedColumns: ['id'];
      ...
      contratos_aprovacoes: {
        Row: {
          ...
          created_at: string;
          id: string;
          nivel: Database['public']['Enums']['contrato_aprovacao_nivel_enum'];
          status: Database['public']['Enums']['contrato_aprovacao_status_enum'];
          usuario_id: string | null;
        };
        Insert: {
          aprovado_em?: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'contratos_aprovacoes_contrato_id_fkey';
            columns: ['contrato_id'];
            isOneToOne: false;
            referencedRelation: 'contratos';
            referencedColumns: ['id'];
      ...
      contratos_clausulas: {
        ...
        Relationships: [
          {
            foreignKeyName: 'contratos_clausulas_contrato_id_fkey';
            columns: ['contrato_id'];
            isOneToOne: false;
            referencedRelation: 'contratos';
            referencedColumns: ['id'];
      ...
      contratos_sla: {
        ...
        Relationships: [
          {
            foreignKeyName: 'contratos_sla_contrato_id_fkey';
            columns: ['contrato_id'];
            isOneToOne: false;
            referencedRelation: 'contratos';
            referencedColumns: ['id'];
      ...
      convenios: {
        Row: {
          ...
          taxa_glosa: number;
          telefone: string;
          tipo: Database['public']['Enums']['convenio_tipo_enum'];
        ...
        Relationships: [
          {
            foreignKeyName: 'convenios_tabela_preco_id_fkey';
      ...
      empresas: {
        Row: {
          ...
          certificado_a1_secret_key: string | null;
          certificado_a1_set_at: string | null;
          cidade: string | null;
          cnpj: string;
      ...
      entrega_historico: {
        Row: {
          ...
          status: Database['public']['Enums']['entrega_status_enum'];
        };
        Insert: {
          cidade?: string | null;
          created_at?: string;
      ...
      entregas: {
        Row: {
          ...
          destino_nome: string;
          destino_tipo: Database['public']['Enums']['entrega_destino_tipo_enum'] | null;
          ...
          origem_nome: string;
          origem_tipo: Database['public']['Enums']['entrega_origem_tipo_enum'] | null;
          pedido_id: string | null;
          peso_kg: number;
          status: Database['public']['Enums']['entrega_status_enum'];
          telefone_contato: string;
          tipo_entrega: Database['public']['Enums']['entrega_modalidade_enum'];
          transportadora: string | null;
          updated_at: string;
          valor_frete: number;
      ...
      fornecedores: {
        Row: {
          ...
          conta: string;
          contato_comercial: Json;
          contato_financeiro: Json;
          created_at: string;
          created_by: string | null;
          criado_em: string | null;
          ...
          rating: number | null;
          razao_social: string;
          segmento: Database['public']['Enums']['fornecedor_segmento_enum'];
          site: string;
          status: string | null;
          telefone: string;
          tempo_resposta_cotacao: number;
          tipo: Database['public']['Enums']['fornecedor_origem_enum'];
          updated_at: string;
          updated_by: string | null;
      ...
      hospitais: {
        Row: {
          ...
          nome: string;
          observacoes: string;
          status: Database['public']['Enums']['hospital_status_enum'];
          telefone: string;
          tipo: Database['public']['Enums']['hospital_tipo_enum'];
          updated_at: string | null;
        };
        Insert: {
          atualizado_em?: string | null;
      ...
      kits: {
        Row: {
          ...
          nome: string;
          observacoes: string;
          status: Database['public']['Enums']['kit_status_enum'];
          updated_at: string | null;
          valor_total: number;
        };
        Insert: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'kits_hospital_id_fkey';
            columns: ['hospital_id'];
            isOneToOne: false;
            referencedRelation: 'hospitais';
            referencedColumns: ['id'];
      ...
      leads: {
        Row: {
          ...
          nome: string;
          observacoes: string;
          origem: Database['public']['Enums']['lead_origem_enum'];
      ...
      lotes_faturamento: {
        Row: {
          ...
          motivos_glosas: Json | null;
          numero_lote: string;
          observacoes: string | null;
          possui_glosas: boolean;
          quantidade_glosas: number;
          quantidade_itens: number;
          risco_glosa: Database['public']['Enums']['lote_faturamento_risco_enum'] | null;
          score_qualidade: number | null;
          status: Database['public']['Enums']['lote_faturamento_status_enum'];
          updated_at: string;
        ...
        Relationships: [
          ...
          {
            foreignKeyName: 'lotes_faturamento_empresa_id_fkey';
            columns: ['empresa_id'];
            isOneToOne: false;
            referencedRelation: 'empresas';
            referencedColumns: ['id'];
      ...
      materiais_opme: {
        Row: {
          ...
          registro_anvisa: string;
          status: Database['public']['Enums']['material_status_enum'];
          tipo: Database['public']['Enums']['material_tipo_enum'];
          unidade_medida: string;
          updated_at: string;
          validade: string;
          valor_unitario: number;
      ...
      medicos: {
        Row: {
          ...
          id: string;
          nome: string;
          status: Database['public']['Enums']['medico_status_enum'];
          taxa_sucesso: number;
          telefone: string;
          updated_at: string;
          usuario_id: string | null;
      ...
      notas_fiscais: {
        Row: {
          ...
          cliente_tipo: Database['public']['Enums']['nota_cliente_tipo_enum'] | null;
          created_at: string;
          criado_em: string | null;
          criado_por: string | null;
          danfe_pdf: string | null;
          danfe_url: string | null;
          data_autorizacao: string | null;
          data_cancelamento: string | null;
          data_emissao: string;
          ...
          serie: string | null;
          status: Database['public']['Enums']['nota_status_app_enum'] | null;
          status_sefaz: string | null;
          tipo: Database['public']['Enums']['nota_documento_tipo_enum'];
          uf: string | null;
          updated_at: string;
          valor_cofins: number | null;
          valor_desconto: number | null;
      ...
      pedidos_compra: {
        Row: {
          ...
          observacoes: string | null;
          status: Database['public']['Enums']['pedido_status_enum'] | null;
          status_en: Database['public']['Enums']['pedido_status_en_enum'];
          updated_at: string;
          urgencia: Database['public']['Enums']['pedido_urgencia_enum'] | null;
          valor_frete: number | null;
          valor_total: number;
        };
        Insert: {
      ...
      portais_opme_config: {
        Row: {
          ...
          tipo_integracao: Database['public']['Enums']['portal_tipo_integracao_enum'];
          total_requisicoes: number | null;
          ultima_requisicao: string | null;
          updated_at: string | null;
          url_base: string;
      ...
      portais_opme_historico: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ['cotacao_id'];
            isOneToOne: false;
            referencedRelation: 'view_portais_opme_cotacoes_recent';
            referencedColumns: ['id'];
          },
        ];
      };
      portais_opme_logs: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ['portal_config_id'];
            isOneToOne: false;
            referencedRelation: 'view_portais_opme_performance';
            referencedColumns: ['portal_config_id'];
          },
          {
      ...
      transacoes: {
        Row: {
          ...
          medico_id: string | null;
          observacoes: string;
          status: Database['public']['Enums']['transacao_status_enum'] | null;
          status_en: Database['public']['Enums']['transacao_status_en_enum'];
          tipo: Database['public']['Enums']['transacao_tipo_enum'];
          updated_at: string;
          valor: number;
        };
        Insert: {
      ...
      user_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: 'user_sessions_terminated_by_fkey';
    ...
    Views: {
      ...
      mv_kpis_empresa: {
        Row: {
          ...
          contas_receber_vencendo: number | null;
          empresa_id: string | null;
          empresa_nome: string | null;
          estoque_critico: number | null;
          faturamento_mensal: number | null;
          margem_lucro: number | null;
          taxa_conversao_crm: number | null;
        };
        Relationships: [];
      };
      v_empresa_ui_configs: {
        Row: {
          allowed_modules_counts: Json | null;
          empresa_id: string | null;
          empresa_nome: string | null;
      ...
      view_contratos_alertas: {
        Row: {
          ...
          resolvido: boolean | null;
          resolvido_em: string | null;
          severidade: Database['public']['Enums']['contrato_alerta_severidade_enum'] | null;
          tipo: Database['public']['Enums']['contrato_alerta_tipo_enum'] | null;
        };
        Relationships: [
          {
            foreignKeyName: 'contratos_alertas_contrato_id_fkey';
      ...
      view_contratos_kpis: {
        Row: {
          ...
          contratos_em_renovacao: number | null;
          contratos_pendentes: number | null;
          empresa_id: string | null;
          taxa_renovacao: number | null;
          valor_total: number | null;
          vencer_30: number | null;
          vencer_90: number | null;
        };
        Relationships: [
          {
            foreignKeyName: 'contratos_empresa_id_fkey';
      ...
      view_portais_opme_cotacoes_recent: {
        Row: {
          data_cotacao: string | null;
          economia_estimada: number | null;
          id: string | null;
      ...
      view_portais_opme_performance: {
        Row: {
          ativo: boolean | null;
          execucoes_erro_30d: number | null;
          execucoes_sucesso_30d: number | null;
          melhor_oferta_medio: number | null;
          ...
          requisicoes_sucesso: number | null;
          retry_max: number | null;
          tempo_execucao_medio_ms: number | null;
          timeout_segundos: number | null;
          tipo_integracao: Database['public']['Enums']['portal_tipo_integracao_enum'] | null;
          total_execucoes_30d: number | null;
          total_requisicoes: number | null;
          ultima_requisicao: string | null;
        };
        Relationships: [];
    ...
    Functions: {
      ...
      is_object_jsonb: { Args: { p: Json }; Returns: boolean };
      is_text_array_jsonb: { Args: { p: Json }; Returns: boolean };
      ...
      next_oportunidade_numero: { Args: never; Returns: string };
      obter_melhor_preco: {
        Args: {
      ...
      reset_my_ui_config:
        ...
        | {
            Args: {
              p_allowed_modules?: Json;
              p_hidden_widgets?: Json;
              p_layout?: Json;
              p_quick_actions?: Json;
            };
            Returns: {
              allowed_modules: Json;
              created_at: string;
      ...
      v_empresa_ui_configs_secure: {
        Args: never;
        Returns: {
          allowed_modules_counts: Json;
          empresa_id: string;
          empresa_nome: string;
    ...
    Enums: {
      contrato_alerta_severidade_enum: 'info' | 'warning' | 'critical';
      contrato_alerta_tipo_enum:
        | 'vencimento'
        | 'renovacao'
        | 'sla'
        | 'inadimplencia'
        | 'assinatura';
      contrato_aprovacao_nivel_enum:
        | 'juridico'
        | 'financeiro'
        | 'diretoria'
        | 'comercial'
        | 'operacional';
      contrato_aprovacao_status_enum: 'pendente' | 'aprovado' | 'rejeitado';
      contrato_indice_enum: 'nenhum' | 'ipca' | 'igpm' | 'inpc' | 'percentual_fixo';
      contrato_periodicidade_enum: 'anual' | 'semestral';
      contrato_status_enum:
        | 'rascunho'
        | 'em_aprovacao'
        | 'ativo'
        | 'renovacao'
      ...
      contrato_tipo_enum:
        ...
        | 'seguro'
        | 'outro';
      convenio_tipo_enum: 'plano_saude' | 'seguros' | 'publico';
      entrega_destino_tipo_enum: 'hospital' | 'medico' | 'clinica' | 'deposito';
      entrega_modalidade_enum: 'normal' | 'expressa' | 'urgente';
      entrega_origem_tipo_enum: 'deposito' | 'fornecedor' | 'hospital';
      entrega_status_enum:
        | 'pendente'
        | 'coletado'
        | 'em_transito'
        ...
        | 'devolvido'
        | 'cancelado';
      fornecedor_origem_enum: 'nacional' | 'internacional';
      fornecedor_segmento_enum:
        | 'fabricante'
        | 'distribuidor'
        | 'importador'
        | 'prestador_servicos'
        | 'servico_logistico'
        | 'outro';
      hospital_status_enum: 'ativo' | 'inativo';
      hospital_tipo_enum: 'publico' | 'privado' | 'filantrópico';
      kit_status_enum: 'montagem' | 'enviado' | 'em_uso' | 'devolvido' | 'faturado';
      lead_estagio_enum:
        | 'novo'
        | 'contato'
        | 'qualificado'
        ...
        | 'perdido'
        | 'desqualificado';
      lead_origem_enum: 'website' | 'indicacao' | 'evento' | 'cold_call' | 'linkedin' | 'outro';
      lead_status_enum: 'ativo' | 'inativo' | 'arquivado';
      lote_faturamento_risco_enum: 'baixo' | 'médio' | 'alto';
      lote_faturamento_status_enum:
        | 'rascunho'
        | 'fechado'
        | 'enviado'
        | 'processando'
        ...
        | 'pago'
        | 'cancelado';
      material_status_enum: 'ativo' | 'inativo' | 'descontinuado';
      material_tipo_enum: 'implante' | 'instrumental' | 'consumivel' | 'dispositivo';
      medico_status_enum: 'ativo' | 'inativo' | 'suspenso';
      nota_cliente_tipo_enum: 'hospital' | 'medico' | 'outro';
      nota_documento_tipo_enum: 'nfe' | 'nfse' | 'cte' | 'mdfe';
      nota_status_app_enum:
        | 'rascunho'
        | 'pendente'
        | 'emitida'
        | 'autorizada'
      ...
      pedido_status_enum:
        ...
        | 'entregue'
        | 'cancelado';
      pedido_urgencia_enum: 'normal' | 'urgente' | 'critico';
      portal_tipo_integracao_enum: 'api_rest' | 'api_graphql' | 'scraping' | 'hibrida';
      ...
      status_item_cirurgia:
        ...
        | 'devolvido'
        | 'perdido';
      transacao_status_en_enum: 'pending' | 'approved' | 'paid' | 'cancelled' | 'overdue';
      transacao_status_enum: 'pendente' | 'aprovada' | 'paga' | 'cancelada' | 'vencido';
      transacao_tipo_enum: 'receita' | 'despesa';
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      contrato_alerta_severidade_enum: ['info', 'warning', 'critical'],
      contrato_alerta_tipo_enum: ['vencimento', 'renovacao', 'sla', 'inadimplencia', 'assinatura'],
      contrato_aprovacao_nivel_enum: [
        'juridico',
        'financeiro',
        'diretoria',
      ...
      nota_cliente_tipo_enum: ['hospital', 'medico', 'outro'],
      nota_documento_tipo_enum: ['nfe', 'nfse', 'cte', 'mdfe'],
      nota_status_app_enum: ['rascunho', 'pendente', 'emitida', 'autorizada', 'cancelada', 'paga'],
      pedido_status_en_enum: [
        'draft',
        'sent',
        'pending',
