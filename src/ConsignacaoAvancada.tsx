...
export const ConsignacaoAvancada: React.FC = () => {
  ...
  const renderHeader = () => (
    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
      <div>
        <h1 className="text-foreground text-body-sm orx-orx-font-extrabold">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div className="neomorphic-inset rounded-lg">
        <Select
          ...
          onValueChange={(value) => setFiltros({ ...filtros, hospital: value })}
          options={[
      ...
      {alertas.length > 0 && (
        <NeomorphicCard  className="border-l-4 border-red-500">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-foreground orx-orx-font-semibold">
          ...
          <div className="space-y-3">
            {alertas.slice(0, 3).map((alerta) => (
              ...
              >
                <h4 className="text-foreground text-body-sm orx-orx-font-medium">
                  {alerta.titulo}
                </h4>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <th className="text-left p-3 text-foreground text-body-sm orx-orx-font-semibold">
                  Código
                </th>
                <th className="text-left p-3 text-foreground text-body-sm orx-orx-font-semibold">
                  Material
                ...
                <th className="text-right p-3 text-foreground text-body-sm orx-orx-font-semibold">
                  Quantidade
                </th>
                <th className="text-right p-3 text-foreground text-body-sm orx-orx-font-semibold">
                  Valor Total
                </th>
                <th className="text-center p-3 text-foreground text-body-sm orx-orx-font-semibold">
                  Status
                </th>
                <th className="text-center p-3 text-foreground text-body-sm orx-orx-font-semibold">
                  Dias Estoque
            ...
            <tbody>
              {materiais.slice(0, 10).map((material) => (
                ...
                >
                  ...
                  <td className="p-3">
                    <div>
                      <div className="text-foreground text-body-sm orx-orx-font-medium">
                        {material.nome}
                      </div>
                      {material.lote && (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-foreground orx-orx-font-semibold">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <span className="text-foreground orx-orx-font-semibold">
