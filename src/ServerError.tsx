      ...
      <div className="max-w-2xl w-full">
        ...
        >
          ...
          <p className="text-text-secondary-light dark:text-text-secondary-dark mb-8" style={{ fontSize: '0.813rem' }}>
            Ocorreu um erro inesperado. Nossos técnicos já foram notificados e estão trabalhando para resolver.
          </p>

          {/* Detalhes do Erro */}
          <div className="mb-8 p-4 bg-destructive/5 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
            <p className="text-red-800 dark:text-red-200 mb-2" style={{ fontWeight: 500 }} style={{ fontSize: '0.813rem' }}>
              O que aconteceu:
            </p>
            <ul className="text-red-700 dark:text-red-300 text-left list-disc list-inside space-y-1" style={{ fontSize: '0.813rem' }}>
          ...
          <div className="mb-8 p-3 bg-[var(--muted)] dark:bg-card rounded font-mono  text-[var(--text-secondary)]" style={{ fontSize: '0.813rem' }}>
            Código do erro: <span className style={{ fontWeight: 700 }}>500</span> | 
            Timestamp: <span className style={{ fontWeight: 700 }}>{new Date().toLocaleString('pt-BR')}</span>
          </div>
