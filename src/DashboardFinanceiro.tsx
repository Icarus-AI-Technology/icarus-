      ...
      >
        ...
        <div className="neumorphic-container p-6">
          ...
          >
            ...
            >
              <TrendingUp
                style={{ width: '1.25rem', height: '1.25rem', color: 'var(--orx-success)' }}
              />
            </div>
          </div>
          <p
        ...
        <div className="neumorphic-container p-6">
          ...
          >
            ...
            >
              <TrendingDown
                style={{ width: '1.25rem', height: '1.25rem', color: 'var(--orx-error)' }}
              />
            </div>
          </div>
          <p
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    {account.type === 'BANK' ? 'Conta Corrente' : 'Cartão de Crédito'} •{' '}
                    {account.number}
                  </p>
                </div>
              </div>
