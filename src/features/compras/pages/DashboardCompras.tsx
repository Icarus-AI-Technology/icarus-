    ...
    <div className="p-8">
      ...
      {typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('qa') === '1' && (
        <div className="neuro-raised rounded-2xl p-4 mb-6">
          <h2 className="text-[0.813rem] font-semibold text-[var(--orx-text-primary)] mb-3">Pedidos (QA)</h2>
      ...
      <div className="neuro-raised rounded-2xl p-6 mb-8">
        <h2 className="text-[0.813rem] font-semibold text-[var(--orx-text-primary)] mb-4 font-display">Ações Rápidas</h2>
      ...
      <div className="neuro-raised rounded-2xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-[0.813rem] font-semibold text-[var(--orx-text-primary)] font-display">Alertas e Pendências</h2>
        </div>
