  ...
  return (
    <div className="p-8">
                ...
                <tbody>
                  {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                    <tr key={i}>
                      ...
                      <td className="p-2">
                        {i % 3 === 0 ? 'Cancelado' : i % 2 === 0 ? 'Aprovado' : 'Pendente'}
                      </td>
                    </tr>
                  ))}
                </tbody>
      ...
      <div className="neuro-raised rounded-2xl p-6 mb-8">
        <h2 className="text-[0.813rem] orx-orx-font-semibold text-[var(--orx-text-primary)] mb-4 font-display">
          Ações Rápidas
        </h2>
      ...
      <div className="neuro-raised rounded-2xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-[0.813rem] orx-orx-font-semibold text-[var(--orx-text-primary)] font-display">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="p-4 rounded-xl border bg-blue-500/10 border-blue-500/30">
            <p className="text-[0.813rem] text-[var(--orx-text-primary)]">
              <strong>IA sugere:</strong> Consolidar compras de 3 fornecedores (economia estimada de
              R$ 23.500,00)
            </p>
          </div>
        </div>
