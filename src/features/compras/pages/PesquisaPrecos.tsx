  ...
  return (
    <div className="min-h-screen p-6 bg-[var(--background)]">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-[var(--text-primary)] mb-2 text-[0.813rem] orx-font-extrabold">
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-[var(--text-primary)] text-[0.813rem] orx-font-semibold">
              Validação ANVISA
            </h2>
          </div>
          ...
          <div className="flex items-start gap-4">
            <div className="flex-1">
              <label className="block text-[var(--text-primary)] mb-2 text-[0.813rem] orx-font-medium">
                Registro ANVISA
              </label>
              <input
                type="text"
            ...
            <button
              ...
              className={cn(
                'mt-7 px-6 py-2.5 rounded-lg orx-font-medium transition-all',
          ...
          {produtoANVISA && (
            <div className="mt-4 p-4 rounded-lg bg-[var(--orx-success)]/10 border border-[var(--orx-success)]">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-[var(--orx-success)] mb-2 text-[0.813rem] orx-font-semibold">
        ...
        <Card className="p-6">
          ...
          <div className="mb-6">
            <label className="block text-[var(--text-primary)] mb-3 text-[0.813rem] orx-font-medium">
            ...
            <div className="flex flex-wrap gap-2">
              {['SP', 'RJ', 'MG', 'PR', 'SC', 'RS', 'BA', 'PE', 'GO', 'DF'].map((uf) => (
                <button
                  ...
                  className={cn(
                    'px-4 py-2 rounded-lg orx-font-medium transition-all',
          ...
          <button
            ...
            className={cn(
              'w-full px-6 py-3 rounded-lg orx-font-medium transition-all',
              'bg-[var(--primary)] text-white hover:bg-[var(--primary-hover)]',
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <Card className="p-4 bg-[var(--orx-success)]/10 border border-[var(--orx-success)]">
                ...
                <p className="text-[var(--orx-success)] text-[0.813rem] orx-font-bold">
              ...
              <Card className="p-4 bg-[var(--primary)]/10 border border-[var(--primary)]">
                ...
                <p className="text-[var(--primary)] text-[0.813rem] orx-font-bold">
              ...
              <Card className="p-4 bg-[var(--orx-error)]/10 border border-[var(--orx-error)]">
                ...
                <p className="text-[var(--orx-error)] text-[0.813rem] orx-font-bold">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 rounded-lg bg-[var(--surface)]">
              <div>
                ...
                <p className="text-[var(--text-primary)] font-mono text-[0.813rem] orx-font-semibold">
                  {precosSEFAZ.ncm}
                </p>
              </div>
              <div>
                ...
                <p className="text-[var(--text-primary)] text-[0.813rem] orx-font-semibold">
              ...
              <div>
                ...
                <p className="text-[var(--orx-warning)] text-[0.813rem] orx-font-semibold">
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {precosSEFAZ.estadosConsultados.map((uf) => (
                  <span
                    key={uf}
                    className="px-3 py-1 rounded-full bg-[var(--primary)]/10 text-[var(--primary)] text-[0.813rem] orx-font-medium"
                  >
                    {uf}
                  </span>
                ))}
