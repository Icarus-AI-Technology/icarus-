...
export class NotificationService {
   ...
   * Enviar SMS
   */
  private static async sendSMS(payload: NotificationPayload): Promise<NotificationResult> {
   ...
   */
  private static async sendPush(payload: NotificationPayload): Promise<NotificationResult> {
   ...
   */
  private static async sendInApp(payload: NotificationPayload): Promise<NotificationResult> {
    try {
      // Salvar no Supabase
