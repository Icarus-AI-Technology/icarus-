  ...
  notifications: [
    {
      ...
      template: 'Pedido de compra aguardando aprovação. Valor: R$ {valor_total}',
    ...
    },
    {
      ...
      stateId: 'aprovado',
      recipients: ['creator'],
      template: 'Seu pedido de compra foi APROVADO! Fornecedor: {fornecedor_nome}',
      channels: ['email', 'in_app'],
    },
    {
    ...
    },
    {
      ...
      template: 'Pedido em trânsito. Previsão de entrega: {data_prevista_entrega}',
