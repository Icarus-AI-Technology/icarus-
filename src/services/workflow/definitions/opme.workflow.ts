  ...
  notifications: [
    {
      ...
      template: 'OPME reservado: {produto_nome} (Lote: {lote}) para cirurgia {cirurgia_id}',
      channels: ['in_app'],
    },
    {
    ...
    },
    {
      ...
      template: 'OPME utilizado: {produto_nome} (S/N: {numero_serie}). Iniciar faturamento.',
  ...
  validations: [
    {
      ...
      validator: async (instance) => {
        return !!instance.metadata?.pacienteId && !!instance.metadata?.cirurgiaId;
      },
    },
  ],
};
...
export const FATURAMENTO_OPME_WORKFLOW: WorkflowDefinition = {
  ...
  notifications: [
    ...
    },
    {
      ...
      template: 'Guia enviada ao convênio: {convenio_nome}. Protocolo: {numero_autorizacao}',
      channels: ['email', 'in_app'],
    },
    {
      ...
      template: 'Faturamento AUTORIZADO! Valor: R$ {valor_total}. Convênio: {convenio_nome}',
    ...
    },
    {
      ...
      template: 'ALERTA: Glosa de R$ {valor_glosado}! Motivo: {motivo_glosa}. Guia: {numero_guia}',
      channels: ['email', 'whatsapp', 'push', 'in_app'],
    },
    {
      ...
      template: 'Faturamento PAGO! Valor: R$ {valor_total}. Convênio: {convenio_nome}',
      channels: ['email', 'in_app'],
    },
  ],
  ...
  validations: [
    ...
    },
    {
      ...
      validator: async (instance) => {
        return !!instance.metadata?.numeroGuia && !!instance.metadata?.convenioId;
      },
    },
  ],
};
