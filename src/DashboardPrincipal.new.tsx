    ...
    <div className="min-h-screen p-6 bg-[var(--orx-bg-light)] dark:bg-[var(--orx-bg-dark)]">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="orx-text-2xl orx-font-bold text-[var(--orx-text-primary)] mb-1">
              Dashboard Principal
            </h1>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="orx-button-primary px-4 py-2.5 rounded-xl flex items-center gap-2 orx-text-sm orx-font-semibold"
              disabled={loading}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="orx-card p-5 rounded-2xl">
            ...
            <div className="space-y-1">
              <p className="orx-text-sm text-[var(--orx-text-secondary)] orx-font-medium">
                Sistema Status
              </p>
              <p className="orx-text-3xl orx-font-bold text-[var(--orx-text-primary)]">
                98%
              </p>
              <div className="flex items-center gap-1 orx-text-xs orx-font-medium text-emerald-600 dark:text-emerald-400">
                <TrendingUp size={14} />
                <span>+2.3%</span>
              </div>
            </div>
          ...
          <div className="orx-card p-5 rounded-2xl">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-1 orx-text-xs orx-font-medium text-red-600 dark:text-red-400">
          ...
          <div className="orx-card p-6 rounded-2xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="orx-text-sm text-[var(--orx-text-secondary)] orx-font-medium mb-2">
                  Faturamento Mensal
                </p>
                <p className="orx-text-4xl orx-font-bold text-[var(--orx-text-primary)] mb-1">
                  R$ 3.8M
                </p>
                <div className="flex items-center gap-3 orx-text-xs">
                  <span className="text-[var(--orx-text-secondary)]">R$ 127K média diária</span>
                  <div className="flex items-center gap-1 text-emerald-600 dark:text-emerald-400 orx-font-medium">
                    <TrendingUp size={12} />
                    <span>+15.3%</span>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="orx-card p-5 rounded-2xl border-l-4 border-red-500">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1">
                <p className="orx-text-sm orx-font-semibold text-[var(--orx-text-primary)]">
                  Estoque Crítico
                </p>
              </div>
            </div>
            <p className="orx-text-3xl orx-font-bold text-[var(--orx-text-primary)] mb-1">
              8
            </p>
