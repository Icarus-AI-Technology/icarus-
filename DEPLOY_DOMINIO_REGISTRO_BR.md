...
3. Selecionar: seu-usuario/icarus-v5.0
4. Configure Project:
...
**Resultado:** URL temporária (ex: `icarus-v5.0.vercel.app`)
...
✅ https://icarus-v5.0.vercel.app (URL Vercel mantida)
```
...
develop → https://icarus-v5.0-git-develop-seu-usuario.vercel.app
feature → https://icarus-v5.0-git-feature-seu-usuario.vercel.app
```
