...
1. **Selecione TODO o código abaixo** (da linha `CREATE EXTENSION` até o final)
2. **Copie** (Cmd+C ou Ctrl+C)
3. **Abra SQL Editor:** https://supabase.com/dashboard/project/ttswvavcisdnonytslom/sql/new
...
Você verá algo como:
```
NOTICE: Migração 0010 concluída! Índices FTS criados: 3
...
```sql
-- Testar busca (vai funcionar mesmo com tabela vazia)
SELECT * FROM buscar_conhecimento('teste');
...
**🚀 Pronto! Depois me avise que continuo com o próximo passo!**
