...
3. Selecionar: icarus-make repository
4. Configure Project:
...
4. Create
5. Connect to Project: icarus-make
...
✅ https://icarus-make.vercel.app (Vercel URL - mantida)
```

### Ambientes:
```
Production:  https://icarusai.com.br (branch: main)
Preview:     https://icarus-make-git-develop-xxx.vercel.app (branch: develop)
