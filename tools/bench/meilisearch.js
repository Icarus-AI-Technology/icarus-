...
async function benchmarkIndexing(client: MeiliSearch, numDocs: number) {
...
async function benchmarkSimpleSearch(client: MeiliSearch, numSearches: number) {
...
async function benchmarkFilteredSearch(client: MeiliSearch, numSearches: number) {
...
async function benchmarkFacetedSearch(client: MeiliSearch, numSearches: number) {
...
async function benchmarkUpdate(client: MeiliSearch, numUpdates: number) {
