...
```bash
# Copiar URL do repositório (ex: https://github.com/seu-usuario/icarus-v5.0.git)

# Adicionar remote
git remote add origin https://github.com/seu-usuario/icarus-v5.0.git
...
2. Import Git Repository
   ...
   - Selecionar: seu-usuario/icarus-v5.0

3. Configure Project:
   Project Name: icarus-v5.0
...
✅ **Deploy concluído!** URL temporária criada: `icarus-v5.0.vercel.app`
...
```bash
1. Acessar projeto: https://vercel.com/seu-usuario/icarus-v5.0
...
# https://icarus-v5.0-git-feature-xxx.vercel.app
```
