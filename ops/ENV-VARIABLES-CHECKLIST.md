...
#### Test Mode (Staging)
- [ ] `VITE_STRIPE_PUBLIC_KEY` - Publishable key (test)
  - Formato: `pk_test_...`
  - Obtido em: Stripe Dashboard → Developers → API keys
...
#### Production Mode
- [ ] Substituir por chaves de produção (`pk_live_...` e `sk_live_...`)
- [ ] Configurar webhooks
- [ ] Ativar compliance necessário
