        ...
        <div className="mt-6">
                    ...
                    <Card key={index} padding="md">
                      <CardContent className="pt-6">
                        <div className="flex items-start justify-between">
                          ...
                          <div
                            className={`p-3 rounded-full ${statTokenMap[stat.color]}`}
                          >
                            <Icon size={20} />
                          </div>
                        </div>
          ...
          {activeTab === "aprovacoes" && (
            <Card>
              <CardHeader>
                <CardTitle>
                  Pedidos Aguardando Aprovação ({pedidosParaAprovar.length})
                </CardTitle>
              </CardHeader>
              <CardContent>
                {pedidosParaAprovar.length === 0 ? (
                  <div className="text-center py-12">
                    <CheckCircle
                      size={48}
                      className="mx-auto mb-4 text-success opacity-30"
                    />
                    <p className="text-[var(--text-secondary)]">
