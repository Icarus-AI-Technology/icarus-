...
export class OPMETraceabilityService {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        return {
          ...
          deviceInfo: {
            ...
            recallInfo: (d.recall as Record<string, unknown> | undefined)
              ? {
                  isRecalled: true,
                  recallDate: (d.recall as Record<string, unknown>).date as
                    | string
                    | undefined,
                  recallReason: (d.recall as Record<string, unknown>).reason as
                    | string
                    | undefined,
                  recallNumber: (d.recall as Record<string, unknown>)
                    .recallNumber as string | undefined,
                }
              : { isRecalled: false },
          },
        ...
        return {
          ...
          verified: false,
          error:
            response.error || "Dispositivo não encontrado no sistema Abbott",
        };
      }
    } catch (error) {
      ...
      if (response.success && response.data) {
        ...
        return {
          ...
          deviceInfo: {
            ...
            lotNumber: d.lotNumber as string | undefined,
            gtin: d.gtin as string | undefined,
            productName: (d.product as Record<string, unknown> | undefined)
              ?.name as string | undefined,
            productDescription: (
              d.product as Record<string, unknown> | undefined
        ...
        return {
          ...
          verified: false,
          error:
            response.error || "Dispositivo não encontrado no sistema Medtronic",
        };
      }
    } catch (error) {
      const err = error as Error;
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        return {
          success: true,
          verified:
            ((d.serialization as Record<string, unknown> | undefined)
              ?.status as string) === "verified",
          deviceInfo: {
            serialNumber: d.serialNumber as string,
            lotNumber: d.lotNumber as string | undefined,
            gtin: d.gtin as string | undefined,
            productName: (d.productInfo as Record<string, unknown> | undefined)
              ?.tradeName as string | undefined,
            productDescription: (
              d.productInfo as Record<string, unknown> | undefined
            )?.description as string | undefined,
            manufacturer: "Johnson & Johnson",
            manufacturingDate: (d.dates as Record<string, unknown> | undefined)
              ?.manufactured as string | undefined,
            expirationDate: (d.dates as Record<string, unknown> | undefined)
            ...
            recallInfo: {
              isRecalled:
                ((d.recall as Record<string, unknown> | undefined)
                  ?.isActive as boolean) === true,
              recallDate: (d.recall as Record<string, unknown> | undefined)
                ?.initiatedDate as string | undefined,
              recallReason: (d.recall as Record<string, unknown> | undefined)
                ?.reason as string | undefined,
              recallNumber: (d.recall as Record<string, unknown> | undefined)
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        return {
          ...
          verified: false,
          error:
            response.error || "Dispositivo não encontrado no sistema Stryker",
        };
      }
    } catch (error) {
      const err = error as Error;
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        return {
          success: true,
          verified:
            ((d.verificationResult as Record<string, unknown> | undefined)
          ...
          deviceInfo: {
            ...
            manufacturingDate: (d.dates as Record<string, unknown> | undefined)
              ?.manufacturing as string | undefined,
            expirationDate: (d.dates as Record<string, unknown> | undefined)
              ?.expiration as string | undefined,
            status: this.mapStatus(d.status as string | undefined),
            recallInfo: {
              isRecalled:
                ((d.recallInfo as Record<string, unknown> | undefined)
                  ?.isActive as boolean) === true,
              recallDate: (d.recallInfo as Record<string, unknown> | undefined)
                ?.date as string | undefined,
              recallReason: (
                d.recallInfo as Record<string, unknown> | undefined
              )?.reason as string | undefined,
        ...
        return {
          ...
          error:
            response.error ||
            "Dispositivo não encontrado no sistema Boston Scientific",
        };
      }
    } catch (error) {
      const err = error as Error;
  ...
  static async verifyDevice(device: DeviceInfo): Promise<TraceabilityResult> {
    try {
      switch (device.manufacturer) {
        ...
        case "medtronic":
          return await this.verifyMedtronic(
            device.serialNumber,
            device.lotNumber,
          );
        ...
        case "boston_scientific":
          return await this.verifyBostonScientific(
            device.serialNumber,
            device.lotNumber,
          );
   ...
   */
  static async verifyMultipleDevices(
    devices: DeviceInfo[],
  ): Promise<TraceabilityResult[]> {
    try {
      ...
      const err = error as Error;
      console.error(
        "[OPME Traceability] Erro ao verificar múltiplos dispositivos:",
        err,
      );
      return [];
    }
        ...
        return {
          ...
          ...(result.deviceInfo.recallInfo.isRecalled && {
            recallInfo: {
              ...
              severity: this.assessRecallSeverity(
                result.deviceInfo.recallInfo.recallReason || "",
              ),
            },
          }),
        };
   ...
   */
  private static assessRecallSeverity(
    reason: string,
