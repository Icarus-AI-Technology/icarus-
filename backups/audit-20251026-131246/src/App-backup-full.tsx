          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 8px 24px rgba(99, 102, 241, 0.4), inset 0 2px 4px rgba(255, 255, 255, 0.1)",
            ...
            >
              <Routes>
                ...
                <Route
                  ...
                  element={<RelatoriosRegulatorios />}
                />
                <Route
                  path="/microsoft365"
                  element={<Microsoft365IntegrationPanel />}
                />

                {/* Cadastros */}
                <Route
                  path="/cadastros"
                  element={<ModulePlaceholder title="Cadastros Inteligentes" />}
                />
                <Route
                  path="/cadastros/medicos"
                  element={<ModulePlaceholder title="Cadastro de Médicos" />}
                />
                <Route
                  path="/cadastros/equipes"
                  element={<ModulePlaceholder title="Equipes Médicas" />}
                />
                <Route
                  path="/cadastros/hospitais"
                  element={<ModulePlaceholder title="Hospitais & Clínicas" />}
                />
                <Route
                  path="/cadastros/convenios"
                  element={<ModulePlaceholder title="Convênios" />}
                />
                <Route
                  path="/cadastros/fornecedores"
                  element={<ModulePlaceholder title="Fornecedores" />}
                />
                <Route
                  path="/cadastros/produtos"
                  element={<ModulePlaceholder title="Produtos OPME" />}
                />

                {/* Compras */}
                <Route
                  path="/compras"
                  element={<ModulePlaceholder title="Compras e Fornecedores" />}
                />
                <Route
                  path="/compras/cotacoes"
                  element={<ModulePlaceholder title="Cotações" />}
                />
                <Route
                  path="/compras/propostas"
                  element={<ModulePlaceholder title="Propostas" />}
                />
                <Route
                  path="/compras/avaliacao"
                  element={
                    <ModulePlaceholder title="Avaliação de Fornecedores" />
                  }
                />
                ...
                <Route
                  path="/contratos"
                  element={<ModulePlaceholder title="Gestão de Contratos" />}
                />
                <Route
                  path="/contratos/dashboard"
                  element={<ModulePlaceholder title="Dashboard Contratos" />}
                />
                <Route
                  path="/contratos/fornecedores"
                  element={<ModulePlaceholder title="Contratos Fornecedores" />}
                />
                <Route
                  path="/contratos/hospitais"
                  element={<ModulePlaceholder title="Contratos Hospitais" />}
                />
                <Route
                  path="/contratos/renovacoes"
                  element={<ModulePlaceholder title="Renovações" />}
                />
                <Route
                  path="/contratos/vencimentos"
                  element={<ModulePlaceholder title="Vencimentos" />}
                />

                {/* CRM e Vendas */}
                <Route
                  path="/crm"
                  element={<ModulePlaceholder title="Vendas & CRM" />}
                />
                <Route
                  path="/crm/prospecoes"
                  element={<ModulePlaceholder title="Prospecções" />}
                />
                <Route
                  path="/crm/propostas"
                  element={<ModulePlaceholder title="Propostas Comerciais" />}
                />
                <Route
                  path="/crm/relacionamento"
                  element={<ModulePlaceholder title="Relacionamento Médicos" />}
                />
                <Route
                  path="/crm/vendas"
                  element={<ModulePlaceholder title="Vendas & Contratos" />}
                />

                {/* Cirurgias */}
                <Route
                  path="/cirurgias"
                  element={<ModulePlaceholder title="Gestão de Cirurgias" />}
                />
                <Route
                  path="/cirurgias/pendentes"
                  element={<ModulePlaceholder title="Pedidos Pendentes" />}
                />
                <Route
                  path="/cirurgias/kits"
                  element={<ModulePlaceholder title="Preparação de Kits" />}
                />
                <Route
                  path="/cirurgias/acompanhamento"
                  element={<ModulePlaceholder title="Acompanhamento" />}
                />
                <Route
                  path="/cirurgias/pos-cirurgico"
                  element={<ModulePlaceholder title="Pós-Cirúrgico" />}
                />

                {/* Estoque */}
                <Route
                  path="/estoque"
                  element={<ModulePlaceholder title="Estoque Inteligente" />}
                />
                <Route
                  path="/estoque/dashboard"
                  element={<ModulePlaceholder title="Visão Geral - Estoque" />}
                />
                <Route
                  path="/estoque/containers"
                  element={<ModulePlaceholder title="Containers IoT" />}
                />
                <Route
                  path="/estoque/scanner"
                  element={<ModulePlaceholder title="Scanner RFID" />}
                />
                <Route
                  path="/estoque/inventario"
                  element={<ModulePlaceholder title="Inventário" />}
                />

                {/* Logística */}
                <Route
                  path="/logistica"
                  element={<ModulePlaceholder title="Logística Avançada" />}
                />
                <Route
                  path="/logistica/rastreamento"
                  element={<ModulePlaceholder title="Rastreamento Real-Time" />}
                />
                <Route
                  path="/logistica/entregas"
                  element={<ModulePlaceholder title="Entregas Ativas" />}
                />
                <Route
                  path="/logistica/rotas"
                  element={<ModulePlaceholder title="Otimização de Rotas" />}
                />
                <Route
                  path="/logistica/transportadoras"
                  element={<ModulePlaceholder title="Transportadoras ANVISA" />}
                />

                {/* Faturamento e Financeiro */}
                <Route
                  path="/faturamento"
                  element={<ModulePlaceholder title="Faturamento Avançado" />}
                />
                <Route
                  path="/financeiro"
                  element={<ModulePlaceholder title="Financeiro Avançado" />}
                />
                <Route
                  path="/financeiro/dashboard"
                  element={<ModulePlaceholder title="Dashboard Financeiro" />}
                />
                <Route
                  path="/financeiro/dda"
                  element={<ModulePlaceholder title="DDA Bancário" />}
                />
                <Route
                  path="/financeiro/sefaz"
                  element={<ModulePlaceholder title="SEFAZ NFe" />}
                />
                <Route
                  path="/financeiro/conciliacao"
                  element={<ModulePlaceholder title="Conciliação" />}
                />
                <Route
                  path="/financeiro/faturamento"
                  element={<ModulePlaceholder title="Faturamento Financeiro" />}
                />

                {/* Analytics */}
                <Route
                  path="/analytics"
                  element={<ModulePlaceholder title="Analytics & BI" />}
                />
                <Route
                  path="/analytics/paineis"
                  element={<ModulePlaceholder title="Painéis de Controle" />}
                />
                <Route
                  path="/analytics/relatorios"
                  element={<ModulePlaceholder title="Relatórios IA" />}
                />
                <Route
                  path="/analytics/kpis"
                ...
                <Route
                  ...
                  element={<ModulePlaceholder title="Previsões IA" />}
                />

                {/* Rastreabilidade */}
                <Route
                  path="/rastreabilidade"
                  element={<ModulePlaceholder title="Rastreabilidade OPME" />}
                />
                <Route
                  path="/rastreabilidade/dashboard"
                  element={<ModulePlaceholder title="Dashboard Rastreamento" />}
                />
                <Route
                  path="/rastreabilidade/produtos"
                  element={<ModulePlaceholder title="Produtos Rastreados" />}
                />
                <Route
                  path="/rastreabilidade/pacientes"
                  element={<ModulePlaceholder title="Por Paciente" />}
                />
                <Route
                  path="/rastreabilidade/historico"
                  element={<ModulePlaceholder title="Histórico & Alertas" />}
                />
                <Route
                  path="/rastreabilidade/mapa"
                  element={<ModulePlaceholder title="Mapa Geográfico" />}
                />

                {/* Manutenção */}
                <Route
                  path="/manutencao"
                  element={<ModulePlaceholder title="Manutenção Preventiva" />}
                />
                <Route
                  path="/manutencao/dashboard"
                  element={
                    <ModulePlaceholder title="Visão Geral - Manutenção" />
                  }
                />
                <Route
                  path="/manutencao/equipamentos"
                  element={<ModulePlaceholder title="Equipamentos Médicos" />}
                />
                <Route
                  path="/manutencao/agendamentos"
                  element={<ModulePlaceholder title="Agendamentos" />}
                />
                <Route
                  path="/manutencao/performance"
                  element={<ModulePlaceholder title="Performance" />}
                />
                <Route
                  path="/manutencao/historico"
                  element={<ModulePlaceholder title="Histórico" />}
                />

                {/* Analytics IA */}
                <Route
                  path="/analytics-ia"
                  element={<ModulePlaceholder title="Analytics Preditivo IA" />}
                />
                <Route
                  path="/analytics-ia/dashboard"
                  element={
                    <ModulePlaceholder title="Visão Geral - Analytics IA" />
                  }
                />
                <Route
                  path="/analytics-ia/predicoes"
                  element={<ModulePlaceholder title="Predições" />}
                />
                <Route
                  path="/analytics-ia/modelos"
                  element={<ModulePlaceholder title="Modelos IA" />}
                />
                <Route
                  path="/analytics-ia/tendencias"
                  element={<ModulePlaceholder title="Tendências" />}
                />
                <Route
                  path="/analytics-ia/insights"
                  element={<ModulePlaceholder title="Insights" />}
                />

                {/* Telemetria e Relatórios */}
                <Route
                  path="/telemetria"
                  element={<ModulePlaceholder title="Telemetria IoT" />}
                />
                <Route
                  path="/relatorios-regulatorios"
                  element={
                    <ModulePlaceholder title="Relatórios Regulatórios" />
                  }
                />
                ...
                <Route
                  path="/ia-central"
                  element={<ModulePlaceholder title="IA Central" />}
                />
                <Route
                  path="/ia-central/dashboard"
                  element={<ModulePlaceholder title="Dashboard IA" />}
                />
                <Route
                  path="/ia-central/orquestrador"
                  element={<ModulePlaceholder title="Orquestrador" />}
                />
                <Route
                  path="/ia-central/chatbot"
                  element={<ModulePlaceholder title="Chatbot Analytics" />}
                />

                {/* API Gateway */}
                <Route
                  path="/api-gateway"
                  element={<ModulePlaceholder title="API Gateway" />}
                />
