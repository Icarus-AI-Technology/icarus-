...
export class ValidacaoService {
   ...
   */
  async consultarCPFReceitaFederal(
    cpf: string,
  ): Promise<ResultadoValidacaoCPF> {
    try {
   ...
   */
  async consultarCNPJReceitaFederal(
    cnpj: string,
  ): Promise<ResultadoValidacaoCNPJ> {
    try {
      // Validar dígitos primeiro
  ...
  async consultarCRM(crm: string, uf: string): Promise<ResultadoValidacaoCRM> {
    try {
      ...
      console.warn(
        "Consulta ao CFM não implementada. Validando apenas formato.",
      );
  ...
  async consultarANVISA(codigo: string): Promise<ResultadoValidacaoANVISA> {
    try {
      ...
      console.warn(
        "Consulta à ANVISA não implementada. Validando apenas formato.",
      );
  ...
  async consultarANS(registro: string): Promise<ResultadoValidacaoANS> {
    try {
      ...
      console.warn(
        "Consulta à ANS não implementada. Validando apenas formato.",
      );
  ...
  async consultarCNES(cnes: string): Promise<ResultadoValidacaoCNES> {
    try {
      ...
      console.warn(
        "Consulta ao CNES/DATASUS não implementada. Validando apenas formato.",
      );
   ...
   */
  async validarEmailComVerificacao(
    email: string,
