...
export const LICITACAO_WORKFLOW: WorkflowDefinition = {
  ...
  description:
    "Workflow completo para participação em processos licitatórios públicos",
  module: "licitacoes",
  ...
  notifications: [
    ...
    },
    {
      ...
      template:
        "ALERTA: Faltam 3 dias para o prazo de envio! Edital: {numero_edital}",
    ...
    },
    {
      ...
      recipientRoles: ["gestor_licitacoes"],
      template:
        "Proposta finalizada! Valor: R$ {valor_proposta}. Prazo de envio: {data_limite}",
      channels: ["email", "in_app"],
    },
    {
      ...
      recipientRoles: ["gestor_licitacoes", "comercial"],
      template:
        "Proposta enviada! Sessão pública em: {data_sessao}. Preparar lances.",
      channels: ["email", "whatsapp", "in_app"],
    },
    {
    ...
    },
    {
      ...
      template:
        "🏆 VITÓRIA NA LICITAÇÃO! Órgão: {orgao_nome}. Valor: R$ {valor_contrato}",
      channels: ["email", "whatsapp", "push", "in_app"],
    },
    {
      ...
      template:
        "ALERTA: Recurso de terceiros contra resultado. Acompanhar processo.",
      channels: ["email", "whatsapp", "push", "in_app"],
    },
    {
  ...
  validations: [
    {
      ...
      message:
        "É necessário verificar se a empresa possui as certidões exigidas",
    ...
    },
    {
      ...
      validator: async (instance) => {
        ...
        return (
          ...
          documentosAnexados.length >= documentosExigidos.length
        );
      },
    },
    {
      ...
      type: "required_fields",
      message:
        "É necessário preencher a planilha de custos e valor final da proposta",
      validator: async (instance) => {
        return (
          !!instance.metadata?.valorProposta &&
          instance.metadata.valorProposta > 0
        );
      },
    },
    {
