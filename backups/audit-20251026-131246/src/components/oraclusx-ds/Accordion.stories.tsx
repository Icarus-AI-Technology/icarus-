...
const sampleItems = [
  ...
  },
  {
    ...
    content:
      "Importe os componentes do pacote @/components/oraclusx-ds e utilize-os em seus projetos.",
  },
  {
    id: "3",
    title: "É responsivo?",
    ...
    items: [
      {
        ...
        content:
          'Você pode resetar sua senha clicando em "Esqueci minha senha" na tela de login e seguindo as instruções enviadas por email.',
      },
      {
        id: "q2",
      ...
      },
      {
        ...
        content:
          "O prazo de entrega varia de acordo com sua região, mas geralmente é de 5 a 10 dias úteis.",
      },
      {
        id: "q4",
        title: "Posso cancelar meu pedido?",
        content:
          "Sim, você pode cancelar seu pedido em até 24 horas após a compra através da área de pedidos.",
      },
    ],
  },
};
