        ...
        <div style={{ position: "relative" }}>
          ...
          <div
            style={{
              ...
              width: "2px",
              background:
                "linear-gradient(180deg, var(--orx-primary) 0%, var(--orx-gray-300) 100%)",
            }}
          />
                  ...
                  <div style={{ flex: 1 }}>
                          ...
                          >
                            {availableActions.map((action) => (
                              <button
                                ...
                                onClick={() =>
                                  onTransition?.(state.id, action.id)
                                }
                                style={{
                                  padding: "0.5rem 1rem",
                                  fontSize: "0.813rem",
                    ...
                    {isCurrent && state.autoProgressAfterDays && (
                      ...
                      >
                        ...
                        >
                          Alerta se permanecer mais de{" "}
                          {state.autoProgressAfterDays} dia(s) neste estado
                        </p>
                      </div>
                    )}
                  </div>
