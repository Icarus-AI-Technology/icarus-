  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.responsavel_cpf)
        errors.responsavel_cpf = "CPF do responsável é obrigatório";
      if (!formData.responsavel_telefone)
        errors.responsavel_telefone = "Telefone do responsável é obrigatório";
      ...
      // Salvar
      await cadastrosService.createHospital(
        formData as Omit<Hospital, "id" | "created_at" | "updated_at">,
      );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-body text-[var(--orx-text-secondary)] mt-1">
            Cadastre hospitais, clínicas e ambulatórios com validações CNPJ e
            CNES
          </p>
        </div>
        <button
        ...
        <div className="neumorphic-card" style={{ padding: "1.5rem" }}>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2
              ...
              style={{ fontSize: "0.813rem", color: "var(--orx-text-primary)" }}
            >
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "0.75rem",
                  borderRadius: "0.5rem",
                  border: validationErrors.razao_social
                    ? "2px solid var(--orx-error)"
                    : "none",
                }}
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "0.75rem",
                  borderRadius: "0.5rem",
                  border: validationErrors.telefone
                    ? "2px solid var(--orx-error)"
                    : "none",
                }}
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "0.75rem",
                  borderRadius: "0.5rem",
                  border: validationErrors.responsavel_nome
                    ? "2px solid var(--orx-error)"
                    : "none",
                }}
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{
                    ...
                    borderRadius: "0.5rem",
                    border: validationErrors.responsavel_cpf
                      ? "2px solid var(--orx-error)"
                      : "none",
                  }}
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "0.75rem",
                  borderRadius: "0.5rem",
                  border: validationErrors.responsavel_telefone
                    ? "2px solid var(--orx-error)"
                    : "none",
                }}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    quantidade_leitos: parseInt(e.target.value) || 0,
                  })
                }
                className="neumorphic-input"
                style={{
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    salas_cirurgicas: parseInt(e.target.value) || 0,
                  })
                }
                className="neumorphic-input"
                style={{
            ...
            <div className="flex items-center" style={{ paddingTop: "2rem" }}>
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    atende_urgencia: e.target.checked,
                  })
                }
                style={{
                  width: "1.25rem",
