            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    medico_responsavel_id: e.target.value,
                  })
                }
                required
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateMembro(index, "medico_nome", e.target.value)
                    }
                    placeholder="Digite o nome ou CRM..."
                    style={{
                      width: "100%",
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <select
                    value={membro.funcao}
                    onChange={(e) =>
                      handleUpdateMembro(index, "funcao", e.target.value)
                    }
                    style={{
                      width: "100%",
                      padding: "0.75rem",
              ...
              {DIAS_SEMANA.map((dia) => (
                <label
                  ...
                  style={{
                    ...
                    background: formData.dias_atuacao?.includes(dia)
                      ? "rgba(99, 102, 241, 0.1)"
                      : "transparent",
                    cursor: "pointer",
                    transition: "all 0.2s",
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    horarios_preferencia: e.target.value,
                  })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    cirurgias_semana_media: parseInt(e.target.value),
                  })
                }
                min="0"
                placeholder="Ex: 5"
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              color: "white",
              cursor:
                loading || formData.membros.length === 0
                  ? "not-allowed"
                  : "pointer",
