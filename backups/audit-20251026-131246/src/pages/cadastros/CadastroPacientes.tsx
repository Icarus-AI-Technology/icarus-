...
export default function CadastroPacientes() {
  ...
  const handleCpfBlur = async () => {
    ...
    try {
      const { valid, message } = await ValidacaoService.validarCPF(
        formData.cpf,
      );
  ...
  const handleCepBlur = async () => {
    ...
    try {
      ...
      } = await ValidacaoService.validarCEP(formData.endereco.cep);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        `Paciente ${novoPaciente.nome_completo} cadastrado com sucesso!`,
      );
      navigate("/cadastros");
    } catch (error: unknown) {
      const err = error as Error;
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                13.709/2018), é necessário o consentimento do paciente para
                coleta e tratamento de seus dados pessoais e dados sensíveis de
                saúde.
              </p>
              ...
              >
                ...
                />
                <span>
                  Autorizo o uso dos meus dados pessoais e de saúde para fins de
                  atendimento médico, faturamento, auditoria e demais atividades
                  relacionadas à prestação de serviços de saúde, conforme
                  descrito na{""}
                  <a
