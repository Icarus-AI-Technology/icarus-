...
const CadastroTransportadoras: React.FC = () => {
  ...
  const [formData, setFormData] =
    useState<TransportadoraFormData>(INITIAL_STATE);
          ...
          >
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    prazo_entrega_medio: parseInt(e.target.value),
                  })
                }
                min="0"
                placeholder="Ex: 3"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    custo_km: parseFloat(e.target.value),
                  })
                }
                min="0"
                step="0.01"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    raio_atendimento: parseInt(e.target.value),
                  })
                }
                min="0"
                placeholder="Ex: 100"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, horario_coleta: e.target.value })
                }
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, possui_api: e.target.checked })
                }
                style={{
                  width: "1.25rem",
                  height: "1.25rem",
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      api_auth_type: e.target
                        .value as TransportadoraFormData["api_auth_type"],
                    })
                  }
                  style={{
                    width: "100%",
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  avaliacao: parseFloat(e.target.value),
                })
              }
