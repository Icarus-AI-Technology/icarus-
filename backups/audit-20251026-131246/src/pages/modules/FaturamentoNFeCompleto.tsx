...
export default function FaturamentoNFeCompleto() {
  ...
  const getStatusBadgeClasses = (status: string) => {
    ...
    return (
      classes[status] ||
      "bg-[var(--orx-gray-500)]/15 text-[var(--orx-gray-500)]"
    );
  };
      ...
      actions={
        <div className="flex items-center gap-3">
          <Button
            ...
            onClick={() =>
              window.dispatchEvent(
                new CustomEvent("icarus:refresh-faturamento"),
              )
            }
          >
          ...
          <Button
            ...
            className="inline-flex items-center gap-2"
            onClick={() =>
              window.dispatchEvent(new CustomEvent("icarus:nova-nfe"))
            }
          >
                    ...
                    <td className="p-4 text-center">
                      <div className="flex items-center justify-center gap-2">
                        <Button
                          ...
                          onClick={() =>
                            window.dispatchEvent(
                              new CustomEvent("icarus:imprimir-danfe", {
                                detail: nfe.id,
                              }),
                            )
                          }
                        ...
                        <Button
                          ...
                          onClick={() =>
                            window.dispatchEvent(
                              new CustomEvent("icarus:download-xml", {
                                detail: nfe.id,
                              }),
                            )
                          }
                        ...
                        <Button
                          ...
                          onClick={() =>
                            window.dispatchEvent(
                              new CustomEvent("icarus:enviar-email", {
                                detail: nfe.id,
                              }),
                            )
                          }
