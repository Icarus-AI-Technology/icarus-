    ...
    <ModulePage
      ...
      actions={
        <Button
          ...
          onClick={() =>
            window.dispatchEvent(new CustomEvent("icarus:novo-usuario"))
          }
        >
                      ...
                      <td style={{ padding: "1rem", textAlign: "center" }}>
                        <div className="flex items-center justify-center gap-2">
                          <Button
                            ...
                            onClick={() =>
                              window.dispatchEvent(
                                new CustomEvent("icarus:editar-usuario", {
                                  detail: usuario.id,
                                }),
                              )
                            }
                          ...
                          <Button
                            ...
                            onClick={() =>
                              window.dispatchEvent(
                                new CustomEvent("icarus:remover-usuario", {
                                  detail: usuario.id,
                                }),
                              )
                            }
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.dispatchEvent(
                        new CustomEvent("icarus:editar-role", {
                          detail: role.id,
                        }),
                      )
                    }
