                  ...
                  <div>
                    ...
                    {req.proxima_auditoria && (
                      <div className="mt-3">
                        ...
                        >
                          <Clock size={14} />
                          {new Date(req.proxima_auditoria).toLocaleDateString(
                            "pt-BR",
                          )}
                        </p>
                      </div>
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right ml-4">
                      ...
                      <Badge
                        variant={
                          aud.status === "concluida" ? "success" : "warning"
                        }
                      >
                        {aud.status}
                      </Badge>
    ...
    <div className="space-y-6">
      ...
      <NeomorphicCard>
        <CardHeader>
          ...
          <CardDescription>
            Sistema CAPA - Ações corretivas e preventivas
          </CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right ml-4">
                      ...
                      <p
                        ...
                        style={{ fontSize: "0.813rem" }}
                      >
                        {new Date(nc.data_identificacao).toLocaleDateString(
                          "pt-BR",
                        )}
                      </p>
                    </div>
    ...
    <div className="space-y-6">
      ...
      <NeomorphicCard>
        <CardHeader>
          ...
          <CardDescription>
            Programa de capacitação e certificação
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right ml-4">
                      ...
                      <Badge
                        variant={
                          trein.status === "concluido" ? "success" : "warning"
                        }
                      >
                        {trein.status}
                      </Badge>
        ...
        {agentesIA.map((agente) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <Badge
                variant={agente.status === "ativo" ? "success" : "default"}
              >
                {agente.status}
              </Badge>
            </div>
      ...
      >
        <div className="space-y-4 p-6">
          ...
          <div className="flex justify-end gap-2">
            <Button
              variant="default"
              onClick={() => setIsNovaAuditoriaOpen(false)}
            >
              Cancelar
            </Button>
