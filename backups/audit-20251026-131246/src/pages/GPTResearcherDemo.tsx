  ...
  const features = [
    {
      ...
      description:
        "Pesquisa web avançada com múltiplas fontes e citações automáticas",
      color: "blue",
    },
    {
      icon: MessageSquare,
      ...
      description:
        "Chat interativo com histórico de mensagens e indicadores visuais",
      color: "green",
    },
    {
      icon: TrendingUp,
      ...
      description:
        "Diferentes tipos de relatórios: pesquisa, detalhado e recursos",
      color: "indigo",
    },
    {
      icon: Zap,
      ...
      <div className="max-w-7xl mx-auto">
            ...
            return (
              ...
              >
                <CardContent className="pt-6">
                  ...
                  <h3
                    className="text-primary dark:text-gray-100 mb-2"
                    style={{ fontWeight: 500 }}
                  >
                    {feature.title}
                  </h3>
            ...
            <CardContent>
              <div className="space-y-2">
                {exemplos.map((exemplo, idx) => (
                  ...
                  >
                    <span className="text-primary dark:text-indigo-400 mr-2">
                      →
                    </span>
                    {exemplo}
                  </div>
        ...
        <div className="mt-8 p-6 bg-indigo-50 dark:bg-indigo-900/30 rounded-xl border-2 border-indigo-200 dark:border-indigo-800">
          ...
          <div className="bg-surface dark:bg-background rounded-lg p-4 font-mono text-body-xs">
            <div className="text-secondary dark:text-muted mb-1">
              # Opção 1: Docker
            </div>
            <code className="text-primary dark:text-gray-100">
              docker run -p 8000:8000 -e OPENAI_API_KEY=sua_chave
              gptresearcher/gpt-researcher
            </code>
            <div className="text-secondary dark:text-muted mt-3 mb-1">
              # Opção 2: Python
            </div>
            <code className="text-primary dark:text-gray-100">
              pip install gpt-researcher && python -m gpt_researcher.server
              --port 8000
            </code>
          </div>
        </div>
