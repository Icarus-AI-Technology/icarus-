...
import { TrendingUp, DollarSign, Users, Award, Settings } from "lucide-react";
export const ConversaoVendas: React.FC = () => {
  const [a, s] = useState("g");
  const c = [
    { id: "g", label: "Geral", icon: TrendingUp, count: 124, trend: "+15" },
    { id: "d", label: "Det", icon: DollarSign, count: 89, trend: "+8" },
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-body-xs">99.2%</p>
            </div>
          </div>
        </header>
        <div className="mb-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Conversão Vendas IA</CardTitle>
          </CardHeader>
          <CardContent>
