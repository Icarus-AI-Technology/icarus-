...
export const RedesSociais: React.FC = () => {
  ...
  const c = [
    { id: "g", label: "Geral", icon: Share2, count: 124, trend: "+15" },
    { id: "d", label: "Det", icon: Users, count: 89, trend: "+8" },
    { id: "a", label: "Ana", icon: TrendingUp, count: 56, trend: "+12" },
    { id: "c", label: "Cfg", icon: Heart, count: 34, trend: "+5" },
  ];
  const k = [
    { title: "Total", value: "303", trend: "+40", icon: Share2, color: "blue" },
    {
      title: "Taxa",
      value: "96.8%",
      trend: "+2%",
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Redes Sociais IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Share2 size={64} className="mx-auto text-muted mb-4" />
