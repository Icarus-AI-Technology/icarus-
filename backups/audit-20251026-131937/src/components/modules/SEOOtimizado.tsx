...
import { Search, TrendingUp, Globe, BarChart3, Settings } from "lucide-react";
export const SEOOtimizado: React.FC = () => {
  const [a, s] = useState("g");
  const c = [
    { id: "g", label: "Geral", icon: Search, count: 124, trend: "+15" },
    { id: "d", label: "Det", icon: TrendingUp, count: 89, trend: "+8" },
    { id: "a", label: "Ana", icon: Globe, count: 56, trend: "+12" },
    { id: "c", label: "Cfg", icon: BarChart3, count: 34, trend: "+5" },
  ];
  const k = [
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-primary rounded-full">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-body-xs">98.5%</p>
            </div>
          </div>
        </header>
        <div className="mb-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>SEO Otimizado IA</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Search size={64} className="mx-auto text-muted mb-4" />
