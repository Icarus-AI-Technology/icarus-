...
export default function LogisticaAvancada() {
  ...
  // Backend Integration
  const { entregas, loading, error, getEstatisticas, getEntregasAtrasadas } =
    useEntregas();
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-[var(--text-secondary)]">
              Sistema inteligente de rotas, entregas e rastreamento em tempo
              real com otimização IA
            </p>
          </div>
        ...
        {activeCategory === "rotas" && (
          <Card className="neuro-raised p-12 text-center">
            ...
            <p className="text-[var(--text-secondary)]">
              Sistema de otimização de rotas com algoritmos de IA em
              desenvolvimento
            </p>
          </Card>
        )}
