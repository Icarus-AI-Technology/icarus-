...
export default function BIDashboardInterativo() {
  ...
  const [periodo, setPeriodo] = useState<"30d" | "90d" | "180d" | "365d">(
    "30d",
  );
          ...
          >
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-2 mt-3">
                ...
                <span className="opacity-80 text-[0.813rem]">
                  {kpi.changeLabel}
                </span>
              </div>
            </div>
            ...
            <div key={index} className="p-4 neuro-flat rounded-lg">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-[0.813rem]">
                  ...
                  <span
                    className={`font-semibold ${vendedor.atingimento_meta_percentual >= 100 ? "text-success" : "text-warning"}`}
                  >
                    {vendedor.atingimento_meta_percentual}%
                  </span>
                </div>
                <Progress
                  value={Math.min(vendedor.atingimento_meta_percentual, 100)}
                />
              </div>
            </div>
          ))}
        ...
        <div className="neuro-raised rounded-3xl p-6 bg-[var(--bg-primary)] border border-[var(--border)] min-h-[300px]">
          {loading ? (
            ...
            <>
              ...
              {activeTab === "clientes" && renderOverview()}{" "}
              {/* Reusa overview por enquanto */}
