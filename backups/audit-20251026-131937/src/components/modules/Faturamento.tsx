            ...
            <div>
              ...
              <div className="h-2">
                <Progress
                  value={Math.min(
                    resumo.totalFaturas > 0
                      ? (resumo.emitidas / resumo.totalFaturas) * 100
                      : 0,
                    100,
                  )}
                />
            ...
            <div>
              <div className="flex justify-between text-body-sm mb-1">
                ...
                <span className="text-[var(--text-primary)] font-medium">
                  {resumo.pendentes} (
                  {resumo.totalFaturas > 0
                    ? ((resumo.pendentes / resumo.totalFaturas) * 100).toFixed(
                        0,
                      )
                    : 0}
                  %)
              ...
              <div className="h-2">
                <Progress
                  value={Math.min(
                    resumo.totalFaturas > 0
                      ? (resumo.pendentes / resumo.totalFaturas) * 100
                      : 0,
                    100,
                  )}
                />
