      ...
      setAlertas([
        {
          ...
          acao_recomendada:
            "Acionar equipe de cobrança e revisar política de crédito",
            ...
            return (
              <Card
                ...
                className={`p-4 neuro-raised cursor-pointer transition-all hover:scale-105 ${
                  categoriaFiltro === est.categoria
                    ? "ring-2 ring-[var(--primary)]"
                    : ""
                }`}
                onClick={() =>
                  setCategoriaFiltro(
                    categoriaFiltro === est.categoria ? null : est.categoria,
                  )
                }
              >
              ...
              >
                <div>
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <h3 className="opacity-90 mb-1 text-[0.813rem] font-medium">
                        {kpi.descricao}
                      </h3>
                      <Badge
                        variant="default"
                        className="bg-white/20 text-white text-[0.813rem]"
                      >
                        {kpi.categoria}
                      </Badge>
                    </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 opacity-80 text-[0.813rem]">
                    ...
                    {kpi.alertas_ativos > 0 && (
                      <Badge
                        variant="default"
                        className="bg-white/20 text-white ml-auto"
                      >
