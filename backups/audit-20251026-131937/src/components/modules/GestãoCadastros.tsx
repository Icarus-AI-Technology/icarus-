              ...
              <tbody>
                {filteredMedicos.map((medico) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span
                        className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-body-xs font-medium ${getStatusColor(medico.status)}`}
                      >
                        {medico.status}
                      </span>
                    </td>
              ...
              <tbody>
                {filteredHospitais.map((hospital) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span
                        className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-body-xs font-medium ${getStatusColor(hospital.status)}`}
                      >
                        {hospital.status}
                      </span>
                    </td>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-[var(--text-secondary)]">
              Sistema inteligente de cadastros com validação em tempo real e
        ...
        {!["medicos", "hospitais"].includes(activeCategory) && (
          <Card className="neuro-raised p-12 text-center">
            {React.createElement(
              categories.find((c) => c.id === activeCategory)?.icon || Package,
              {
                className:
                  "w-16 h-16 text-[var(--text-secondary)] mx-auto mb-4",
              },
            )}
            ...
            <p className="text-body-sm text-[var(--text-secondary)] mt-2">
              ...
              {activeCategory === "pacientes" && "Sistema de Prontuários"}
