...
const FORMATO_ICONS: Record<
  string,
  typeof FileText | typeof FileSpreadsheet | typeof FileCog
> = {
  PDF: FileText,
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="p-4 neuro-raised">
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-[var(--text-secondary)] text-[0.813rem] font-medium">
                Total Gerados
              </h3>
          ...
          <Table>
            ...
            <TableBody>
              {relatoriosFiltrados.map((relatorio) => {
                ...
                const orgaoConfig = ORGAOS.find(
                  (o) => o.value === relatorio.orgao,
                );
                  ...
                  <TableRow key={relatorio.id}>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <OrgaoIcon
                          className={`w-4 h-4 ${orgaoConfig?.color}`}
                        />
                        <div>
                    ...
                    <TableCell>
                      {formatNumber(relatorio.total_registros)}
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      {relatorio.gerado_em
                        ? new Date(relatorio.gerado_em).toLocaleDateString(
                            "pt-BR",
                          )
                        : "-"}
                    </TableCell>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-[var(--text-secondary)] mb-3 text-[0.813rem]">
                  Frequência: {agendamento.frequencia} • Dia{" "}
                  {agendamento.dia_execucao} às {agendamento.hora_execucao}:00
                </p>
                ...
                {agendamento.destinatarios_email &&
                  agendamento.destinatarios_email.length > 0 && (
    ...
    <div className="space-y-6">
      <Card className="p-6 neuro-raised bg-gradient-to-br from-green-500 to-green-600 text-white">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h2 className="text-[0.813rem] font-bold">
        ...
        <p className="opacity-80 text-[0.813rem]">
          Como distribuidora de OPME, você DEVE manter rastreabilidade completa
          de todos os produtos, desde o recebimento até a entrega ao
          hospital/clínica.
        </p>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6 neuro-raised">
          ...
          <p className="text-[var(--text-secondary)] mt-2 text-[0.813rem]">
            Últimos 30 dias
          </p>
        </Card>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-4">
                <Button
                  variant="secondary"
                  onClick={() => setIsGerarDialogOpen(false)}
                >
                  Cancelar
                </Button>
