...
export const CardTitle = React.forwardRef<HTMLHeadingElement, CardTitleProps>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn(
        "text-heading-sm font-medium text-primary dark:text-gray-100",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "text-body-sm text-secondary dark:text-muted mt-1",
      className,
    )}
    {...props}
  />
...
export const CardFooter = React.forwardRef<HTMLDivElement, CardFooterProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "mt-4 pt-4 border-t border-gray-200 dark:border-border",
        className,
      )}
      {...props}
    />
