...
const sampleTabs = [
  ...
  },
  {
    id: "tab3",
    label: "Configurações",
    content: <div className="p-4">Conteúdo da aba Configurações</div>,
  },
];
    ...
    tabs: [
      {
        id: "1",
        label: "Dashboard",
        content: <div className="p-4">Dashboard</div>,
      },
      {
        id: "2",
        label: "Relatórios",
        content: <div className="p-4">Relatórios</div>,
      },
      {
        id: "3",
        label: "Análises",
        content: <div className="p-4">Análises</div>,
      },
      {
        id: "4",
        label: "Configurações",
        content: <div className="p-4">Configurações</div>,
      },
      {
        id: "5",
        label: "Usuários",
        content: <div className="p-4">Usuários</div>,
      },
      {
        id: "6",
        label: "Notificações",
        content: <div className="p-4">Notificações</div>,
      },
    ],
    variant: "horizontal",
  },
