      ...
      setAlertas([
        {
          ...
          descricao:
            "A certificação ISO 13485 para dispositivos médicos vencerá em 45 dias.",
          severidade: "urgente",
        ...
        },
        {
          ...
          descricao:
            "POP-001 - Procedimento de Esterilização requer revisão em 28 dias.",
          severidade: "aviso",
      ...
      <div className="p-8 flex items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Executando análise de compliance...
          </p>
        </div>
      </div>
    );
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Monitoramento 24/7 de requisitos regulatórios • Taxa de acerto:
            96.8%
          </p>
        </div>
        <button
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    {alerta.tipo === "certificacao" && (
                      <Shield className="w-5 h-5" />
                    )}
                    {alerta.tipo === "treinamento" && (
                      <CheckCircle className="w-5 h-5" />
                    )}
                    {alerta.tipo === "documento" && (
                      <FileText className="w-5 h-5" />
                    )}
                    {alerta.tipo === "calibracao" && (
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm text-slate-600 dark:text-slate-400">
                    ...
                    {alerta.prazo_acao && (
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          Ação até{" "}
                          {new Date(alerta.prazo_acao).toLocaleDateString(
                            "pt-BR",
                          )}
                        </span>
                      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 mt-3">
              O agente analisa certificações, treinamentos e documentos
              automaticamente, gerando alertas preditivos com 90, 30 e 60 dias
              de antecedência.
            </p>
          </div>
        </div>
