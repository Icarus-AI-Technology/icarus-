...
export const CIRURGIA_WORKFLOW: WorkflowDefinition = {
  ...
  description:
    "Workflow completo para gerenciamento de cirurgias desde agendamento até conclusão",
  module: "cirurgias",
  ...
  notifications: [
    {
      ...
      template:
        "Cirurgia confirmada para {data_hora}. Hospital: {hospital_nome}",
    ...
    },
    {
      ...
      template:
        "Cirurgia {procedimento} entrando em preparação. Verificar OPME.",
    ...
    },
    {
      ...
      template:
        "Cirurgia {procedimento} CANCELADA. Motivo: {motivo_cancelamento}",
  ...
  validations: [
    {
      ...
      message:
        "É necessário confirmar a equipe médica antes de iniciar a preparação",
