            ...
            <div className="flex items-center gap-4">
              ...
              <h1
                style={{
                  ...
                  fontWeight: 600,
                  background:
                    "linear-gradient(to right, var(--orx-primary), var(--orx-primary-hover))",
              ...
              <div className="p-6">
                <Routes>
                  ...
                  <Route
                    ...
                    element={<ComplianceAuditoria />}
                  />
                  <Route path="/bi-analytics" element={<BIAnalytics />} />
                  <Route
                    path="/autenticacao"
                    element={<AutenticacaoAvancada />}
                  />
                  <Route
                    path="/notificacoes"
                    element={<SistemaNotificacoes />}
                  />
                  <Route
                    path="/integracoes"
                    element={<IntegracoesExternas />}
                  />
                  <Route path="/chat" element={<ChatEnterprise />} />
                  <Route path="/nfe-automatica" element={<NFeAutomatica />} />
                  <Route
                    path="/agendamento"
                    element={<AgendamentoCirurgico />}
                  />
                  ...
                  <Route
                    ...
                    element={<AnalyticsPredicao />}
                  />
                  <Route path="/chatbot-metrics" element={<ChatBotMetrics />} />
                  <Route
                    path="/modulos-analytics"
                    element={<ModulosAnalytics />}
                  />
                  <Route
                    path="/modulos-avancados"
                    element={<ModulosAvancados />}
                  />
                  <Route
                    path="/modulos-compliance"
                    element={<ModulosCompliance />}
                  />
                  ...
                  <Route
                    path="/beneficios"
                    element={<BeneficiosColaboradores />}
                  />
                  <Route path="/capacitacao-ia" element={<CapacitacaoIA />} />
                  <Route
                    path="/escalas-funcionarios"
                    element={<EscalasFuncionarios />}
                  />
                  <Route path="/folha-pagamento" element={<FolhaPagamento />} />
                  <Route
                    path="/onboarding-digital"
                    element={<OnboardingDigital />}
                  />
                  <Route
                    path="/performance-equipes"
                    element={<PerformanceEquipes />}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<SegurancaTrabalho />}
                  />
                  <Route
                    path="/treinamento-equipes"
                    element={<TreinamentoEquipes />}
                  />

                  {/* Estoque & Inventário */}
                  <Route
                    path="/estoque-avancado"
                    element={<EstoqueAvancado />}
                  />
                  <Route
                    path="/gestao-inventario"
                    element={<GestaoInventario />}
                  />
                  <Route
                    path="/inventario-inteligente"
                    element={<InventarioInteligente />}
                  />

                  {/* Compras & Fornecedores */}
                  <Route
                    path="/compras-internacionais"
                    element={<ComprasInternacionais />}
                  />
                  <Route
                    path="/cotacoes-automaticas"
                    element={<CotacoesAutomaticas />}
                  />
                  <Route
                    path="/fornecedores-avancado"
                    element={<FornecedoresAvancado />}
                  />
                  <Route path="/notas-compra" element={<NotasCompra />} />
                  <Route path="/pedidos-compra" element={<PedidosCompra />} />
                  <Route
                    path="/viabilidade-importacao"
                    element={<ViabilidadeImportacao />}
                  />

                  {/* Logística & Frota */}
                  <Route path="/combustivel-ia" element={<CombustivelIA />} />
                  <Route
                    path="/entregas-automaticas"
                    element={<EntregasAutomaticas />}
                  />
                  <Route
                    path="/expedicao-mercadorias"
                    element={<ExpedicaoMercadorias />}
                  />
                  ...
                  />
                  <Route
                    path="/manutencao-frota"
                    element={<ManutencaoFrota />}
                  />
                  <Route
                    path="/rotas-otimizadas"
                    element={<RotasOtimizadas />}
                  />
                  <Route
                    path="/telemetria-veiculos"
                    element={<TelemetriaVeiculos />}
                  />
                  <Route
                    path="/transportadoras-ia"
                    element={<TransportadorasIA />}
                  />
                  ...
                  <Route
                    ...
                    element={<CampanhasAutomaticas />}
                  />
                  <Route
                    path="/contas-receber-ia"
                    element={<ContasReceberIA />}
                  />
                  <Route
                    path="/conversao-vendas"
                    element={<ConversaoVendas />}
                  />
                  <Route path="/email-marketing" element={<EmailMarketing />} />
                  <Route path="/gestao-leads" element={<GestaoLeads />} />
                  <Route
                    path="/leads-qualificados"
                    element={<LeadsQualificados />}
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={<RelacionamentoCliente />}
                  />
                  <Route path="/seo-otimizado" element={<SEOOtimizado />} />

                  {/* Produtos & OPME */}
                  <Route
                    path="/certificacoes-anvisa"
                    element={<CertificacoesAnvisa />}
                  />
                  <Route
                    path="/grupos-produtos-opme"
                    element={<GruposProdutosOPME />}
                  />
