...
export default function RelatoriosRegulatorios() {
  ...
  const kpis = [
    ...
    },
    {
      ...
      icon: AlertTriangle,
      iconBg:
        "linear-gradient(135deg, var(--orx-error), var(--orx-error-dark))",
      color: "var(--orx-error)",
    },
    {
      title: "Enviados (Mês)",
      ...
      actions={
        <div className="flex items-center gap-3">
          <Button
            ...
            onClick={() =>
              window.dispatchEvent(new CustomEvent("icarus:baixar-relatorios"))
            }
          >
          ...
          <Button
            ...
            className="inline-flex items-center gap-2"
            onClick={() =>
              window.dispatchEvent(new CustomEvent("icarus:enviar-relatorios"))
            }
          >
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Shield
                        size={24}
                        style={{ color: getTipoColor(relatorio.tipo) }}
                      />
                    </div>
                    <div>
                      <span
                ...
                <div className="flex items-center gap-2 mt-4 pt-4 border-t border-gray-200">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.dispatchEvent(
                        new CustomEvent("icarus:download-relatorio", {
                          detail: relatorio.id,
                        }),
                      )
                    }
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.dispatchEvent(
                        new CustomEvent("icarus:enviar-relatorio", {
                          detail: relatorio.id,
                        }),
                      )
                    }
