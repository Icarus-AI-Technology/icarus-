...
const CadastroProdutosOPME: React.FC = () => {
  ...
  React.useEffect(() => {
    if (formData.preco_custo && formData.margem_lucro) {
      const precoVenda =
        formData.preco_custo * (1 + formData.margem_lucro / 100);
    ...
    <div style={{ padding: "1.5rem" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ color: "var(--orx-text-secondary)" }}>
          Preencha os dados do produto para ortopedia, materiais especiais e
          medicamentos
        </p>
      </div>
          ...
          >
            <div>
              ...
              >
                Código Interno{" "}
                <span
                  style={{ color: "var(--orx-error)", fontSize: "0.813rem" }}
                >
                  *
                </span>
              </label>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, codigo_anvisa: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, codigo_tuss: e.target.value })
                }
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              >
                Descrição Completa{" "}
                <span style={{ color: "var(--orx-error)" }}>*</span>
              </label>
              <textarea
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    classe_risco: e.target
                      .value as ProdutoOPMEFormData["classe_risco"],
                  })
                }
                style={{
                  width: "100%",
        ...
        >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    margem_lucro: parseFloat(e.target.value) || 0,
                  })
                }
                required
                min="0"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    preco_minimo: parseFloat(e.target.value),
                  })
                }
                min="0"
                step="0.01"
          ...
          >
            ...
            >
              <Calculator
                size={20}
                style={{ color: "var(--orx-info)", marginTop: "2px" }}
              />
              <div>
                <p
                  style={{
                ...
                >
                  Preço de Venda calculado automaticamente: R${" "}
                  {formData.preco_venda.toFixed(2)}
                </p>
                <p
                  style={{
                    fontSize: "0.813rem",
                ...
                >
                  Fórmula: Custo (R$ {formData.preco_custo.toFixed(2)}) × (1 +
                  Margem ({formData.margem_lucro}%))
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    ponto_pedido: parseInt(e.target.value),
                  })
                }
                min="0"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    localizacao_estoque: e.target.value,
                  })
                }
        ...
        >
          ...
          >
            {[
              ...
              {
                key: "controla_numero_serie",
                label: "Controla Número de Série",
              },
              ...
              >
                <input
                  type="checkbox"
                  checked={
                    formData[key as keyof ProdutoOPMEFormData] as boolean
                  }
                  onChange={(e) =>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      temperatura_minima: parseInt(e.target.value),
                    })
                  }
                  placeholder="Ex: 2"
                  style={{
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      temperatura_maxima: parseInt(e.target.value),
                    })
                  }
                  placeholder="Ex: 8"
                  style={{
