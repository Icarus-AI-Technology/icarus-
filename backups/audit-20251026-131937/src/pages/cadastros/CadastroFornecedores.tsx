...
const CadastroFornecedores: React.FC = () => {
  ...
  const calcularAvaliacaoGeral = () => {
    ...
    return avaliacoes.some((v) => v > 0)
      ? soma / avaliacoes.filter((v) => v > 0).length
      : 0;
  };
    ...
    <div style={{ padding: "1.5rem" }}>
      ...
      >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    tipo: e.target.value as FornecedorFormData["tipo"],
                  })
                }
                required
                style={{
              ...
              >
                ...
                <option value="prestador_servicos">
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    contato_comercial_nome: e.target.value,
                  })
                }
                placeholder="Nome"
                style={{
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    contato_comercial_telefone: e.target.value,
                  })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    contato_comercial_email: e.target.value,
                  })
                }
                placeholder="Email"
                style={{
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    contato_financeiro_nome: e.target.value,
                  })
                }
                placeholder="Nome"
                style={{
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    contato_financeiro_telefone: e.target.value,
                  })
                }
                placeholder="Telefone"
                style={{
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    contato_financeiro_email: e.target.value,
                  })
                }
                placeholder="Email"
                style={{
        ...
        >
          ...
          >
            {["qualidade", "pontualidade", "atendimento", "preco"].map(
              (tipo) => (
                <div key={tipo}>
                  <label
                    style={{
