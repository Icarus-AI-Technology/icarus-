...
export default function CadastroMedicos() {
  ...
  const [possiveisDuplicatas, setPossiveisDuplicatas] = useState<
    PossivelDuplicata[]
  >([]);
    ...
    if (crm && uf) {
      ...
      try {
        ...
        if (!resultado.ativo) {
          ...
          const duplicatas =
            await duplicateDetectionService.detectPossibleDuplicates({
              tipo: "medico",
              crm,
              uf_crm: uf,
            });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-body text-[var(--orx-text-secondary)] mt-1">
            Cadastre médicos com validações em tempo real e detecção de
            duplicatas
          </p>
        </div>
        <button
      ...
      {possiveisDuplicatas.length > 0 && (
        <div className="neumorphic-card p-4 border-2 border-[var(--orx-warning)] bg-[var(--orx-bg-light)]">
          <div className="flex items-start gap-3">
            <AlertTriangle
              size={24}
              className="text-[var(--orx-warning)] shrink-0"
            />
            <div className="flex-1">
              ...
              <ul className="mt-2 ml-4">
                {possiveisDuplicatas.map((dup, idx) => (
                  <li
                    key={idx}
                    className="text-[0.813rem] text-[var(--orx-text-primary)] mb-1"
                  >
                    • {dup.nome} - {dup.motivo}
                  </li>
                ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              {validationErrors.nome_completo && (
                <p className="text-[0.813rem] text-[var(--orx-error)] mt-1">
                  {validationErrors.nome_completo}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  value={formData.crm}
                  onChange={(e) =>
                    handleCRMChange(e.target.value, formData.uf_crm)
                  }
                ...
                {validatingCRM && (
                  <div className="absolute right-3 top-1/2 -translate-y-1/2">
                    <Loader2
                      size={18}
                      className="animate-spin text-[var(--orx-primary)]"
                    />
                  </div>
                )}
              </div>
        ...
        <div className="neumorphic-card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              >
                Celular (WhatsApp){" "}
                <span className="text-[var(--orx-error)]">*</span>
              </label>
              <input
                id="celular"
                type="tel"
