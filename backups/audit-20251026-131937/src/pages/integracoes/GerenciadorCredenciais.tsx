  ...
  const carregarCredenciais = async () => {
    try {
      ...
      const credenciaisMap = new Map(
        configData?.map((c) => [c.nome, c.valor]) || [],
      );
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="neumorphic-card p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="neumorphic-inset p-4 rounded-lg">
            <div className="text-sm" style={{ color: "var(--orx-success)" }}>
              Configuradas
            </div>
            <div
          ...
          <div className="neumorphic-inset p-4 rounded-lg">
            <div className="text-sm" style={{ color: "var(--orx-warning)" }}>
              Pendentes
            </div>
            <div
              className="text-2xl font-bold"
              style={{ color: "var(--orx-warning)" }}
            >
              {estatisticas.pendentes}
            </div>
          </div>
          <div className="neumorphic-inset p-4 rounded-lg">
            <div className="text-sm" style={{ color: "var(--orx-danger)" }}>
              Inválidas
            </div>
            <div
              className="text-2xl font-bold"
              style={{ color: "var(--orx-danger)" }}
            >
          ...
          <div key={cred.id} className="neumorphic-card p-6">
            ...
            <div className="flex gap-3">
              <div className="flex-1 relative">
                <input
                  type={
                    showPassword[cred.id] || cred.tipo === "text"
                      ? "text"
                      : "password"
                  }
                  value={cred.valor || ""}
