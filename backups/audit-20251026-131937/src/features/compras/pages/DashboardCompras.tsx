    ...
    <div className="p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-[0.813rem] font-extrabold text-[var(--orx-text-primary)] mb-1 font-display">
      ...
      {typeof window !== "undefined" &&
        new URLSearchParams(window.location.search).get("qa") === "1" && (
          <form
            aria-label="Filtros QA Compras"
            className="rounded-2xl p-4 neuro-raised mb-6 grid [grid-template-columns:1.2fr_0.8fr_0.8fr_0.6fr] gap-3 items-end"
          >
            <div>
              <label
                htmlFor="qa-busca-compras"
              ...
              <input
                id="qa-busca-compras"
                name="busca"
                placeholder="Fornecedor, pedido, cotação"
                className="w-full px-3 py-2 rounded-xl"
              />
            </div>
            <div>
              <label
                htmlFor="qa-periodo-inicio"
                className="text-[0.75rem] text-[var(--orx-text-secondary)]"
              >
                Início
              </label>
              <input
                id="qa-periodo-inicio"
                name="inicio"
                type="date"
                className="w-full px-3 py-2 rounded-xl"
              />
            ...
            <div>
              <label
                htmlFor="qa-status-compras"
                className="text-[0.75rem] text-[var(--orx-text-secondary)]"
              >
                Status
              </label>
              <select
                id="qa-status-compras"
                name="status"
                className="w-full px-3 py-2 rounded-xl"
              >
      ...
      <div className="neuro-raised rounded-2xl p-6 mb-8">
        <h2 className="text-[0.813rem] font-semibold text-[var(--orx-text-primary)] mb-4 font-display">
          Ações Rápidas
        </h2>
      ...
      <div className="neuro-raised rounded-2xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-[0.813rem] font-semibold text-[var(--orx-text-primary)] font-display">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="p-4 rounded-xl border bg-blue-500/10 border-blue-500/30">
            <p className="text-[0.813rem] text-[var(--orx-text-primary)]">
              <strong>IA sugere:</strong> Consolidar compras de 3 fornecedores
              (economia estimada de R$ 23.500,00)
            </p>
          </div>
        </div>
      </div>
