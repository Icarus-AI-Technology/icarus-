...
export const GestaoCotacoes: React.FC = () => {
  ...
  const cotacoesFiltradas = cotacoes.filter((cotacao) => {
    ...
    const matchStatus =
      filterStatus === "todos" || cotacao.status === filterStatus;
    const matchPrioridade =
      filterPrioridade === "todas" || cotacao.prioridade === filterPrioridade;
    ...
    >
      ...
      >
        <div>
          ...
          >
            Criação, comparação e análise inteligente de cotações
            multi-fornecedor
          </p>
        </div>
        <button
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          (
                          {
                            cotacao.fornecedores.filter(
                              (f) => f.status === "respondida",
                            ).length
                          }{" "}
                          respondidas)
                        </span>
