...
test.describe("Módulos Padronizados - Batch 1 (Core)", () => {
  ...
  test("Dashboard Principal - deve carregar com KPIs", async ({ page }) => {
    ...
    // Verifica título
    await expect(
      page.locator('h1:has-text("Dashboard Principal")'),
    ).toBeVisible();
  ...
  test("Contas a Receber IA - deve exibir NavigationBar", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Contas a Receber IA")'),
    ).toBeVisible();
  ...
  test("Relatórios Executivos - Dashboard C-Level", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Relatórios Executivos")'),
    ).toBeVisible();
...
test.describe("Módulos Padronizados - Batch 2 (Comerciais)", () => {
  ...
  test("Relacionamento com Cliente - CRM", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Relacionamento com Cliente")'),
    ).toBeVisible();
  ...
  test("Compras Internacionais - Importações", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Compras Internacionais")'),
    ).toBeVisible();
  ...
  test("Logística Transportadoras - Fretes", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Logística Transportadoras")'),
    ).toBeVisible();
  ...
  test("Consignação Avançada - Kits", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Consignação Avançada")'),
    ).toBeVisible();
  ...
  test("Rastreabilidade OPME - Lotes", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Rastreabilidade OPME")'),
    ).toBeVisible();
...
test.describe("Módulos Padronizados - Batch 3 (Operacionais)", () => {
  test("Gestão de Inventário - Contagens", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Gestão de Inventário")'),
    ).toBeVisible();
  ...
  test("Grupos de Produtos OPME - Categorização", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Grupos de Produtos OPME")'),
    ).toBeVisible();
  ...
  test("Tabelas de Preços - Gestão unificada", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Tabelas de Preços")'),
    ).toBeVisible();
  ...
  test("Viabilidade de Importação - Simulações", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Viabilidade de Importação")'),
    ).toBeVisible();
