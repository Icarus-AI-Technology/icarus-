...
| Nome | Status | Arquivo/Path |
|------|--------|-------------|
| `valida_crm_cfm` | ✅ PRESENTE | `/Users/daxmeneghel/icarus-v5.0/supabase/functions/valida_crm_cfm/index.ts` |
| `consulta_anvisa_produto` | ✅ PRESENTE | `/Users/daxmeneghel/icarus-v5.0/supabase/functions/consulta_anvisa_produto/index.ts` |
| `recalcular_kpis` | ✅ PRESENTE | `/Users/daxmeneghel/icarus-v5.0/supabase/functions/recalcular_kpis/index.ts` |
